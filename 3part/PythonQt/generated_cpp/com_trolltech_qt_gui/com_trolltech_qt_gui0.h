...
class PythonQtShell_QAbstractFileIconProvider : public QAbstractFileIconProvider
{
public:
    PythonQtShell_QAbstractFileIconProvider():QAbstractFileIconProvider(),_wrapper(nullptr) {};

   ~PythonQtShell_QAbstractFileIconProvider() override;

QIcon  icon(QAbstractFileIconProvider::IconType  arg__1) const override;
QIcon  icon(const QFileInfo&  arg__1) const override;
...
class PythonQtPublicPromoter_QAbstractFileIconProvider : public QAbstractFileIconProvider
{ public:
inline QIcon  py_q_icon(QAbstractFileIconProvider::IconType  arg__1) const { return QAbstractFileIconProvider::icon(arg__1); }
inline QIcon  py_q_icon(const QFileInfo&  arg__1) const { return QAbstractFileIconProvider::icon(arg__1); }
inline QAbstractFileIconProvider::Options  py_q_options() const { return QAbstractFileIconProvider::options(); }
inline void py_q_setOptions(QAbstractFileIconProvider::Options  arg__1) { QAbstractFileIconProvider::setOptions(arg__1); }
inline QString  py_q_type(const QFileInfo&  arg__1) const { return QAbstractFileIconProvider::type(arg__1); }
};

class PythonQtWrapper_QAbstractFileIconProvider : public QObject
{ Q_OBJECT
public:
Q_ENUMS(IconType Option )
Q_FLAGS(Options )
enum IconType{
  Computer = QAbstractFileIconProvider::Computer,   Desktop = QAbstractFileIconProvider::Desktop,   Trashcan = QAbstractFileIconProvider::Trashcan,   Network = QAbstractFileIconProvider::Network,   Drive = QAbstractFileIconProvider::Drive,   Folder = QAbstractFileIconProvider::Folder,   File = QAbstractFileIconProvider::File};
enum Option{
  DontUseCustomDirectoryIcons = QAbstractFileIconProvider::DontUseCustomDirectoryIcons};
Q_DECLARE_FLAGS(Options, Option)
public Q_SLOTS:
QAbstractFileIconProvider* new_QAbstractFileIconProvider();
void delete_QAbstractFileIconProvider(QAbstractFileIconProvider* obj) { delete obj; }
   QIcon  icon(QAbstractFileIconProvider* theWrappedObject, QAbstractFileIconProvider::IconType  arg__1) const;
   QIcon  py_q_icon(QAbstractFileIconProvider* theWrappedObject, QAbstractFileIconProvider::IconType  arg__1) const{  return (((PythonQtPublicPromoter_QAbstractFileIconProvider*)theWrappedObject)->py_q_icon(arg__1));}
   QIcon  icon(QAbstractFileIconProvider* theWrappedObject, const QFileInfo&  arg__1) const;
   QIcon  py_q_icon(QAbstractFileIconProvider* theWrappedObject, const QFileInfo&  arg__1) const{  return (((PythonQtPublicPromoter_QAbstractFileIconProvider*)theWrappedObject)->py_q_icon(arg__1));}
   QAbstractFileIconProvider::Options  options(QAbstractFileIconProvider* theWrappedObject) const;
   QAbstractFileIconProvider::Options  py_q_options(QAbstractFileIconProvider* theWrappedObject) const{  return (((PythonQtPublicPromoter_QAbstractFileIconProvider*)theWrappedObject)->py_q_options());}
   void setOptions(QAbstractFileIconProvider* theWrappedObject, QAbstractFileIconProvider::Options  arg__1);
   void py_q_setOptions(QAbstractFileIconProvider* theWrappedObject, QAbstractFileIconProvider::Options  arg__1){  (((PythonQtPublicPromoter_QAbstractFileIconProvider*)theWrappedObject)->py_q_setOptions(arg__1));}
   QString  type(QAbstractFileIconProvider* theWrappedObject, const QFileInfo&  arg__1) const;
   QString  py_q_type(QAbstractFileIconProvider* theWrappedObject, const QFileInfo&  arg__1) const{  return (((PythonQtPublicPromoter_QAbstractFileIconProvider*)theWrappedObject)->py_q_type(arg__1));}
};
...
inline QList<int >  py_q_paintingRoles() const { return QAbstractItemDelegate::paintingRoles(); }
...
void delete_QAbstractItemDelegate(QAbstractItemDelegate* obj) { delete obj; }
   ...
   bool  handleEditorEvent(QAbstractItemDelegate* theWrappedObject, QObject*  object, QEvent*  event);
   ...
   QList<int >  paintingRoles(QAbstractItemDelegate* theWrappedObject) const;
   QList<int >  py_q_paintingRoles(QAbstractItemDelegate* theWrappedObject) const{  return (((PythonQtPublicPromoter_QAbstractItemDelegate*)theWrappedObject)->py_q_paintingRoles());}
...
inline void py_q_dataChanged(const QModelIndex&  topLeft, const QModelIndex&  bottomRight, const QList<int >&  roles = QList<int>()) { QAbstractItemView::dataChanged(topLeft, bottomRight, roles); }
...
inline void py_q_initViewItemOption(QStyleOptionViewItem*  option) const { QAbstractItemView::initViewItemOption(option); }
...
inline QAbstractItemDelegate*  py_q_itemDelegateForIndex(const QModelIndex&  index) const { return QAbstractItemView::itemDelegateForIndex(index); }
...
void delete_QAbstractItemView(QAbstractItemView* obj) { delete obj; }
   ...
   void py_q_dataChanged(QAbstractItemView* theWrappedObject, const QModelIndex&  topLeft, const QModelIndex&  bottomRight, const QList<int >&  roles = QList<int>()){  (((PythonQtPublicPromoter_QAbstractItemView*)theWrappedObject)->py_q_dataChanged(topLeft, bottomRight, roles));}
   ...
   void initViewItemOption(QAbstractItemView* theWrappedObject, QStyleOptionViewItem*  option) const;
   void py_q_initViewItemOption(QAbstractItemView* theWrappedObject, QStyleOptionViewItem*  option) const{  (((PythonQtPublicPromoter_QAbstractItemView*)theWrappedObject)->py_q_initViewItemOption(option));}
   ...
   QAbstractItemDelegate*  itemDelegateForIndex(QAbstractItemView* theWrappedObject, const QModelIndex&  index) const;
   QAbstractItemDelegate*  py_q_itemDelegateForIndex(QAbstractItemView* theWrappedObject, const QModelIndex&  index) const{  return (((PythonQtPublicPromoter_QAbstractItemView*)theWrappedObject)->py_q_itemDelegateForIndex(index));}
   ...
   Qt::MatchFlags  keyboardSearchFlags(QAbstractItemView* theWrappedObject) const;
   ...
   void setKeyboardSearchFlags(QAbstractItemView* theWrappedObject, Qt::MatchFlags  searchFlags);
   ...
   void setUpdateThreshold(QAbstractItemView* theWrappedObject, int  threshold);
   ...
   int  updateThreshold(QAbstractItemView* theWrappedObject) const;
...
enum PrintDialogOption{
  PrintToFile = QAbstractPrintDialog::PrintToFile,   PrintSelection = QAbstractPrintDialog::PrintSelection,   PrintPageRange = QAbstractPrintDialog::PrintPageRange,   PrintShowPageSize = QAbstractPrintDialog::PrintShowPageSize,   PrintCollateCopies = QAbstractPrintDialog::PrintCollateCopies,   PrintCurrentPage = QAbstractPrintDialog::PrintCurrentPage};
enum PrintRange{
...
{ public:
inline QModelIndex  promoted_createSourceIndex(int  row, int  col, void*  internalPtr) const { return this->createSourceIndex(row, col, internalPtr); }
...
inline bool  py_q_clearItemData(const QModelIndex&  index) { return QAbstractProxyModel::clearItemData(index); }
...
inline QHash<int , QByteArray >  py_q_roleNames() const { return QAbstractProxyModel::roleNames(); }
...
void delete_QAbstractProxyModel(QAbstractProxyModel* obj) { delete obj; }
   ...
   bool  py_q_clearItemData(QAbstractProxyModel* theWrappedObject, const QModelIndex&  index){  return (((PythonQtPublicPromoter_QAbstractProxyModel*)theWrappedObject)->py_q_clearItemData(index));}
   QModelIndex  createSourceIndex(QAbstractProxyModel* theWrappedObject, int  row, int  col, void*  internalPtr) const;
   ...
   QHash<int , QByteArray >  py_q_roleNames(QAbstractProxyModel* theWrappedObject) const{  return (((PythonQtPublicPromoter_QAbstractProxyModel*)theWrappedObject)->py_q_roleNames());}
...
inline void py_q_initStyleOption(QStyleOptionSpinBox*  option) const { QAbstractSpinBox::initStyleOption(option); }
...
void delete_QAbstractSpinBox(QAbstractSpinBox* obj) { delete obj; }
   ...
   void py_q_initStyleOption(QAbstractSpinBox* theWrappedObject, QStyleOptionSpinBox*  option) const{  (((PythonQtPublicPromoter_QAbstractSpinBox*)theWrappedObject)->py_q_initStyleOption(option));}
...
void delete_QAbstractTextDocumentLayout(QAbstractTextDocumentLayout* obj) { delete obj; }
   ...
   QTextBlock  blockWithMarkerAt(QAbstractTextDocumentLayout* theWrappedObject, const QPointF&  pos) const;
...
class PythonQtShell_QAccessibilityHints : public QAccessibilityHints
{
public:
    PythonQtShell_QAccessibilityHints(QObject*  parent = nullptr):QAccessibilityHints(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QAccessibilityHints() override;
...
class PythonQtPublicPromoter_QAccessibilityHints : public QAccessibilityHints
{ public:
inline bool  promoted_event(QEvent*  event) { return this->event(event); }
inline bool  py_q_event(QEvent*  event) { return QAccessibilityHints::event(event); }
};

class PythonQtWrapper_QAccessibilityHints : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QAccessibilityHints* new_QAccessibilityHints(QObject*  parent = nullptr);
void delete_QAccessibilityHints(QAccessibilityHints* obj) { delete obj; }
   Qt::ContrastPreference  contrastPreference(QAccessibilityHints* theWrappedObject) const;
   bool  py_q_event(QAccessibilityHints* theWrappedObject, QEvent*  event){  return (((PythonQtPublicPromoter_QAccessibilityHints*)theWrappedObject)->py_q_event(event));}
};
...
void delete_QAction(QAction* obj) { delete obj; }
   ...
   QList<QObject* >  associatedObjects(QAction* theWrappedObject) const;
   ...
   bool  showStatusText(QAction* theWrappedObject, QObject*  object = nullptr);
...
{
public:
    PythonQtShell_QActionEvent(const QActionEvent&  arg__1):QActionEvent(arg__1),_wrapper(nullptr) {};
    PythonQtShell_QActionEvent(int  type, QAction*  action, QAction*  before = nullptr):QActionEvent(type, action, before),_wrapper(nullptr) {};

   ~PythonQtShell_QActionEvent() override;

QActionEvent*  clone() const override;
...
{ public:
inline QActionEvent&  promoted_operator_assign(const QActionEvent&  other) { return this->QActionEvent::operator=(other); }
...
public:
public Q_SLOTS:
QActionEvent* new_QActionEvent(const QActionEvent&  arg__1);
...
void delete_QActionEvent(QActionEvent* obj) { delete obj; }
   ...
   QActionEvent*  operator_assign(QActionEvent* theWrappedObject, const QActionEvent&  other);
};
...
void delete_QActionGroup(QActionGroup* obj) { delete obj; }
   ...
   QActionGroup::ExclusionPolicy  exclusionPolicy(QActionGroup* theWrappedObject) const;
...
void delete_QApplication(QApplication* obj) { delete obj; }
   ...
   bool  autoSipEnabled(QApplication* theWrappedObject) const;
   ...
   void*  resolveInterface(QApplication* theWrappedObject, const char*  name, int  revision) const;
...
inline void py_q_setSpacing(int  spacing) { QBoxLayout::setSpacing(spacing); }
inline QSize  py_q_sizeHint() const { return QBoxLayout::sizeHint(); }
inline int  py_q_spacing() const { return QBoxLayout::spacing(); }
...
void delete_QBoxLayout(QBoxLayout* obj) { delete obj; }
   ...
   void py_q_setSpacing(QBoxLayout* theWrappedObject, int  spacing){  (((PythonQtPublicPromoter_QBoxLayout*)theWrappedObject)->py_q_setSpacing(spacing));}
   ...
   int  py_q_spacing(QBoxLayout* theWrappedObject) const{  return (((PythonQtPublicPromoter_QBoxLayout*)theWrappedObject)->py_q_spacing());}
...
inline void promoted_keyPressEvent(QKeyEvent*  event) { this->keyPressEvent(event); }
inline void promoted_mousePressEvent(QMouseEvent*  event) { this->mousePressEvent(event); }
inline void promoted_paintCell(QPainter*  painter, const QRect&  rect, QDate  date) const { this->paintCell(painter, rect, date); }
inline void promoted_resizeEvent(QResizeEvent*  event) { this->resizeEvent(event); }
inline void promoted_updateCell(QDate  date) { this->updateCell(date); }
...
inline void py_q_paintCell(QPainter*  painter, const QRect&  rect, QDate  date) const { QCalendarWidget::paintCell(painter, rect, date); }
...
void delete_QCalendarWidget(QCalendarWidget* obj) { delete obj; }
   QCalendar  calendar(QCalendarWidget* theWrappedObject) const;
   void clearMaximumDate(QCalendarWidget* theWrappedObject);
   void clearMinimumDate(QCalendarWidget* theWrappedObject);
   ...
   QTextCharFormat  dateTextFormat(QCalendarWidget* theWrappedObject, QDate  date) const;
   ...
   void paintCell(QCalendarWidget* theWrappedObject, QPainter*  painter, const QRect&  rect, QDate  date) const;
   void py_q_paintCell(QCalendarWidget* theWrappedObject, QPainter*  painter, const QRect&  rect, QDate  date) const{  (((PythonQtPublicPromoter_QCalendarWidget*)theWrappedObject)->py_q_paintCell(painter, rect, date));}
   ...
   void setCalendar(QCalendarWidget* theWrappedObject, QCalendar  calendar);
   ...
   void setDateTextFormat(QCalendarWidget* theWrappedObject, QDate  date, const QTextCharFormat&  format);
   ...
   void setMaximumDate(QCalendarWidget* theWrappedObject, QDate  date);
   void setMinimumDate(QCalendarWidget* theWrappedObject, QDate  date);
   ...
   void updateCell(QCalendarWidget* theWrappedObject, QDate  date);
...
inline void py_q_initStyleOption(QStyleOptionButton*  option) const { QCheckBox::initStyleOption(option); }
...
void delete_QCheckBox(QCheckBox* obj) { delete obj; }
   ...
   void py_q_initStyleOption(QCheckBox* theWrappedObject, QStyleOptionButton*  option) const{  (((PythonQtPublicPromoter_QCheckBox*)theWrappedObject)->py_q_initStyleOption(option));}
...
class PythonQtShell_QChildWindowEvent : public QChildWindowEvent
{
public:
    PythonQtShell_QChildWindowEvent(QEvent::Type  type, QWindow*  childWindow):QChildWindowEvent(type, childWindow),_wrapper(nullptr) {};
    PythonQtShell_QChildWindowEvent(const QChildWindowEvent&  arg__1):QChildWindowEvent(arg__1),_wrapper(nullptr) {};

   ~PythonQtShell_QChildWindowEvent() override;

QChildWindowEvent*  clone() const override;
void setAccepted(bool  accepted) override;

  PythonQtInstanceWrapper* _wrapper;
};

class PythonQtPublicPromoter_QChildWindowEvent : public QChildWindowEvent
{ public:
inline QChildWindowEvent&  promoted_operator_assign(const QChildWindowEvent&  other) { return this->QChildWindowEvent::operator=(other); }
inline QChildWindowEvent*  py_q_clone() const { return QChildWindowEvent::clone(); }
};

class PythonQtWrapper_QChildWindowEvent : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QChildWindowEvent* new_QChildWindowEvent(QEvent::Type  type, QWindow*  childWindow);
QChildWindowEvent* new_QChildWindowEvent(const QChildWindowEvent&  arg__1);
void delete_QChildWindowEvent(QChildWindowEvent* obj) { delete obj; }
   QWindow*  child(QChildWindowEvent* theWrappedObject) const;
   QChildWindowEvent*  py_q_clone(QChildWindowEvent* theWrappedObject) const{  return (((PythonQtPublicPromoter_QChildWindowEvent*)theWrappedObject)->py_q_clone());}
   QChildWindowEvent*  operator_assign(QChildWindowEvent* theWrappedObject, const QChildWindowEvent&  other);
};
...
{
public:
    PythonQtShell_QCloseEvent():QCloseEvent(),_wrapper(nullptr) {};
    PythonQtShell_QCloseEvent(const QCloseEvent&  arg__1):QCloseEvent(arg__1),_wrapper(nullptr) {};

   ~PythonQtShell_QCloseEvent() override;
...
{ public:
inline QCloseEvent&  promoted_operator_assign(const QCloseEvent&  other) { return this->QCloseEvent::operator=(other); }
inline QCloseEvent*  py_q_clone() const { return QCloseEvent::clone(); }
};
...
QCloseEvent* new_QCloseEvent(const QCloseEvent&  arg__1);
void delete_QCloseEvent(QCloseEvent* obj) { delete obj; }
   QCloseEvent*  py_q_clone(QCloseEvent* theWrappedObject) const{  return (((PythonQtPublicPromoter_QCloseEvent*)theWrappedObject)->py_q_clone());}
   QCloseEvent*  operator_assign(QCloseEvent* theWrappedObject, const QCloseEvent&  other);
};
...
enum ColorDialogOption{
  ShowAlphaChannel = QColorDialog::ShowAlphaChannel,   NoButtons = QColorDialog::NoButtons,   DontUseNativeDialog = QColorDialog::DontUseNativeDialog,   NoEyeDropperButton = QColorDialog::NoEyeDropperButton};
...
class PythonQtWrapper_QColorSpace : public QObject
{ Q_OBJECT
public:
Q_ENUMS(ColorModel NamedColorSpace Primaries TransferFunction TransformModel )
enum class ColorModel{
  Undefined = static_cast<int>(QColorSpace::ColorModel::Undefined),   Rgb = static_cast<int>(QColorSpace::ColorModel::Rgb),   Gray = static_cast<int>(QColorSpace::ColorModel::Gray),   Cmyk = static_cast<int>(QColorSpace::ColorModel::Cmyk)};
enum NamedColorSpace{
  SRgb = QColorSpace::SRgb,   SRgbLinear = QColorSpace::SRgbLinear,   AdobeRgb = QColorSpace::AdobeRgb,   DisplayP3 = QColorSpace::DisplayP3,   ProPhotoRgb = QColorSpace::ProPhotoRgb,   Bt2020 = QColorSpace::Bt2020,   Bt2100Pq = QColorSpace::Bt2100Pq,   Bt2100Hlg = QColorSpace::Bt2100Hlg};
enum class Primaries{
  Custom = static_cast<int>(QColorSpace::Primaries::Custom),   SRgb = static_cast<int>(QColorSpace::Primaries::SRgb),   AdobeRgb = static_cast<int>(QColorSpace::Primaries::AdobeRgb),   DciP3D65 = static_cast<int>(QColorSpace::Primaries::DciP3D65),   ProPhotoRgb = static_cast<int>(QColorSpace::Primaries::ProPhotoRgb),   Bt2020 = static_cast<int>(QColorSpace::Primaries::Bt2020)};
enum class TransferFunction{
  Custom = static_cast<int>(QColorSpace::TransferFunction::Custom),   Linear = static_cast<int>(QColorSpace::TransferFunction::Linear),   Gamma = static_cast<int>(QColorSpace::TransferFunction::Gamma),   SRgb = static_cast<int>(QColorSpace::TransferFunction::SRgb),   ProPhotoRgb = static_cast<int>(QColorSpace::TransferFunction::ProPhotoRgb),   Bt2020 = static_cast<int>(QColorSpace::TransferFunction::Bt2020),   St2084 = static_cast<int>(QColorSpace::TransferFunction::St2084),   Hlg = static_cast<int>(QColorSpace::TransferFunction::Hlg)};
enum class TransformModel{
  ThreeComponentMatrix = static_cast<int>(QColorSpace::TransformModel::ThreeComponentMatrix),   ElementListProcessing = static_cast<int>(QColorSpace::TransformModel::ElementListProcessing)};
public Q_SLOTS:
QColorSpace* new_QColorSpace();
QColorSpace* new_QColorSpace(QColorSpace::NamedColorSpace  namedColorSpace);
QColorSpace* new_QColorSpace(QColorSpace::Primaries  primaries, QColorSpace::TransferFunction  transferFunction, float  gamma = 0.0f);
QColorSpace* new_QColorSpace(QColorSpace::Primaries  primaries, float  gamma);
QColorSpace* new_QColorSpace(QPointF  whitePoint, QColorSpace::TransferFunction  transferFunction, float  gamma = 0.0f);
QColorSpace* new_QColorSpace(const QColorSpace&  colorSpace);
QColorSpace* new_QColorSpace(const QColorSpace::PrimaryPoints&  primaryPoints, QColorSpace::TransferFunction  transferFunction, float  gamma = 0.0f);
QColorSpace* new_QColorSpace(const QPointF&  whitePoint, const QPointF&  redPoint, const QPointF&  greenPoint, const QPointF&  bluePoint, QColorSpace::TransferFunction  transferFunction, float  gamma = 0.0f);
void delete_QColorSpace(QColorSpace* obj) { delete obj; }
   QColorSpace::ColorModel  colorModel(QColorSpace* theWrappedObject) const;
   QString  description(QColorSpace* theWrappedObject) const;
   QColorSpace  static_QColorSpace_fromIccProfile(const QByteArray&  iccProfile);
   float  gamma(QColorSpace* theWrappedObject) const;
   QByteArray  iccProfile(QColorSpace* theWrappedObject) const;
   bool  isValid(QColorSpace* theWrappedObject) const;
   bool  isValidTarget(QColorSpace* theWrappedObject) const;
   bool  __ne__(QColorSpace* theWrappedObject, const QColorSpace&  colorSpace2);
   void writeTo(QColorSpace* theWrappedObject, QDataStream&  arg__1);
   QColorSpace*  operator_assign(QColorSpace* theWrappedObject, const QColorSpace&  colorSpace);
   bool  __eq__(QColorSpace* theWrappedObject, const QColorSpace&  colorSpace2);
   void readFrom(QColorSpace* theWrappedObject, QDataStream&  arg__1);
   QColorSpace::Primaries  primaries(QColorSpace* theWrappedObject) const;
   QColorSpace::PrimaryPoints  primaryPoints(QColorSpace* theWrappedObject) const;
   void setDescription(QColorSpace* theWrappedObject, const QString&  description);
   void setPrimaries(QColorSpace* theWrappedObject, QColorSpace::Primaries  primariesId);
   void setPrimaries(QColorSpace* theWrappedObject, const QPointF&  whitePoint, const QPointF&  redPoint, const QPointF&  greenPoint, const QPointF&  bluePoint);
   void setPrimaryPoints(QColorSpace* theWrappedObject, const QColorSpace::PrimaryPoints&  primaryPoints);
   void setTransferFunction(QColorSpace* theWrappedObject, QColorSpace::TransferFunction  transferFunction, float  gamma = 0.0f);
   void setWhitePoint(QColorSpace* theWrappedObject, QPointF  whitePoint);
   void swap(QColorSpace* theWrappedObject, QColorSpace&  colorSpace);
   QColorSpace::TransferFunction  transferFunction(QColorSpace* theWrappedObject) const;
   QColorSpace::TransformModel  transformModel(QColorSpace* theWrappedObject) const;
   QColorTransform  transformationToColorSpace(QColorSpace* theWrappedObject, const QColorSpace&  colorspace) const;
   QPointF  whitePoint(QColorSpace* theWrappedObject) const;
   QColorSpace  withTransferFunction(QColorSpace* theWrappedObject, QColorSpace::TransferFunction  transferFunction, float  gamma = 0.0f) const;
    QString py_toString(QColorSpace*);
    bool __nonzero__(QColorSpace* obj) { return obj->isValid(); }
};
