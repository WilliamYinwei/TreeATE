...
QString PythonQtWrapper_QPixelFormat::py_toString(QPixelFormat* obj) {
  QString result;
  QDebug d(&result);
  d << *obj;
  return result;
...
{
  return &( ((PythonQtPublicPromoter_QPlatformSurfaceEvent*)theWrappedObject)->promoted_operator_assign(other));
}
...
qsizetype  PythonQtWrapper_QPolygonF::static_QPolygonF_maxSize()
{
  return (QPolygonF::maxSize());
}

qsizetype  PythonQtWrapper_QPolygonF::max_size(QPolygonF* theWrappedObject) const
{
...
void PythonQtWrapper_QPolygonF::resizeForOverwrite(QPolygonF* theWrappedObject, qsizetype  size)
{
...
if (_wrapper) {
  PYTHONQT_GIL_SCOPE
  if (Py_REFCNT((PyObject*)_wrapper) > 0) {
    static PyObject* name = PyUnicode_FromString("printerState");
    PyObject* obj = PyBaseObject_Type.tp_getattro((PyObject*)_wrapper, name);
    if (obj) {
...
if (_wrapper) {
  PYTHONQT_GIL_SCOPE
  if (Py_REFCNT((PyObject*)_wrapper) > 0) {
    static PyObject* name = PyUnicode_FromString("text");
    PyObject* obj = PyBaseObject_Type.tp_getattro((PyObject*)_wrapper, name);
    if (obj) {
...
if (_wrapper) {
  PYTHONQT_GIL_SCOPE
  if (Py_REFCNT((PyObject*)_wrapper) > 0) {
    static PyObject* name = PyUnicode_FromString("itemTextRect");
    PyObject* obj = PyBaseObject_Type.tp_getattro((PyObject*)_wrapper, name);
    if (obj) {
...
QQuaternion  PythonQtWrapper_QQuaternion::static_QQuaternion_fromAxes(QQuaternion::Axes  axes)
{
  return (QQuaternion::fromAxes(axes));
}
...
QQuaternion  PythonQtWrapper_QQuaternion::__sub__(QQuaternion* theWrappedObject)
{
...
QQuaternion::Axes  PythonQtWrapper_QQuaternion::toAxes(QQuaternion* theWrappedObject) const
{
  return ( theWrappedObject->toAxes());
}
...
PythonQtShell_QQuaternion__Axes::~PythonQtShell_QQuaternion__Axes() {
  PythonQtPrivate* priv = PythonQt::priv();
  if (priv) { priv->shellClassDeleted(this); }
}
QQuaternion::Axes* PythonQtWrapper_QQuaternion__Axes::new_QQuaternion__Axes()
{ 
return new PythonQtShell_QQuaternion__Axes(); }



PythonQtShell_QQuaternion__Axis::~PythonQtShell_QQuaternion__Axis() {
  PythonQtPrivate* priv = PythonQt::priv();
  if (priv) { priv->shellClassDeleted(this); }
}
QQuaternion::Axis* PythonQtWrapper_QQuaternion__Axis::new_QQuaternion__Axis()
{ 
return new PythonQtShell_QQuaternion__Axis(); }

QQuaternion::Axis  PythonQtWrapper_QQuaternion__Axis::static_QQuaternion__Axis_fromVector3D(QVector3D  v)
{
  return (QQuaternion::Axis::fromVector3D(v));
}

QVector3D  PythonQtWrapper_QQuaternion__Axis::toVector3D(QQuaternion::Axis* theWrappedObject) const
{
...
QByteArray  PythonQtWrapper_QRawFont::fontTable(QRawFont* theWrappedObject, QFont::Tag  tag) const
{
  return ( theWrappedObject->fontTable(tag));
}
...
unsigned int  PythonQtWrapper_QRawFont::glyphCount(QRawFont* theWrappedObject) const
{
  return ( theWrappedObject->glyphCount());
}
...
QString  PythonQtWrapper_QRawFont::glyphName(QRawFont* theWrappedObject, unsigned int  glyphIndex) const
{
  return ( theWrappedObject->glyphName(glyphIndex));
}
