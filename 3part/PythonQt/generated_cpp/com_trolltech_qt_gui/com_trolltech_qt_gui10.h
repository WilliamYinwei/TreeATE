...
enum ViewItemFeature{
  None = QStyleOptionViewItem::None,   WrapText = QStyleOptionViewItem::WrapText,   Alternate = QStyleOptionViewItem::Alternate,   HasCheckIndicator = QStyleOptionViewItem::HasCheckIndicator,   HasDisplay = QStyleOptionViewItem::HasDisplay,   HasDecoration = QStyleOptionViewItem::HasDecoration,   IsDecoratedRootColumn = QStyleOptionViewItem::IsDecoratedRootColumn,   IsDecorationForRootColumn = QStyleOptionViewItem::IsDecorationForRootColumn};
...
void delete_QSurfaceFormat(QSurfaceFormat* obj) { delete obj; }
   ...
   std::pair<int , int >  version(QSurfaceFormat* theWrappedObject) const;
...
inline void py_q_dropEvent(QDropEvent*  event) { QTableView::dropEvent(event); }
...
void delete_QTableView(QTableView* obj) { delete obj; }
   ...
   void py_q_dropEvent(QTableView* theWrappedObject, QDropEvent*  event){  (((PythonQtPublicPromoter_QTableView*)theWrappedObject)->py_q_dropEvent(event));}
...
void delete_QTableWidget(QTableWidget* obj) { delete obj; }
   ...
   void setSupportedDragActions(QTableWidget* theWrappedObject, Qt::DropActions  actions);
   ...
   Qt::DropActions  supportedDragActions(QTableWidget* theWrappedObject) const;
...
QTableWidgetSelectionRange* a = new QTableWidgetSelectionRange();
*((QTableWidgetSelectionRange*)a) = other;
return a; }
void delete_QTableWidgetSelectionRange(QTableWidgetSelectionRange* obj) { delete obj; }
   ...
   bool  __ne__(QTableWidgetSelectionRange* theWrappedObject, const QTableWidgetSelectionRange&  rhs);
   bool  __eq__(QTableWidgetSelectionRange* theWrappedObject, const QTableWidgetSelectionRange&  rhs);
...
{
public:
    PythonQtShell_QTabletEvent(QEvent::Type  t, const QPointingDevice*  device, const QPointF&  pos, const QPointF&  globalPos, qreal  pressure, float  xTilt, float  yTilt, float  tangentialPressure, qreal  rotation, float  z, Qt::KeyboardModifiers  keyState, Qt::MouseButton  button, Qt::MouseButtons  buttons):QTabletEvent(t, device, pos, globalPos, pressure, xTilt, yTilt, tangentialPressure, rotation, z, keyState, button, buttons),_wrapper(nullptr) {};
    PythonQtShell_QTabletEvent(const QTabletEvent&  arg__1):QTabletEvent(arg__1),_wrapper(nullptr) {};

   ~PythonQtShell_QTabletEvent() override;

QTabletEvent*  clone() const override;
...
{ public:
inline QTabletEvent&  promoted_operator_assign(const QTabletEvent&  other) { return this->QTabletEvent::operator=(other); }
...
public:
public Q_SLOTS:
QTabletEvent* new_QTabletEvent(QEvent::Type  t, const QPointingDevice*  device, const QPointF&  pos, const QPointF&  globalPos, qreal  pressure, float  xTilt, float  yTilt, float  tangentialPressure, qreal  rotation, float  z, Qt::KeyboardModifiers  keyState, Qt::MouseButton  button, Qt::MouseButtons  buttons);
QTabletEvent* new_QTabletEvent(const QTabletEvent&  arg__1);
void delete_QTabletEvent(QTabletEvent* obj) { delete obj; }
   ...
   QTabletEvent*  operator_assign(QTabletEvent* theWrappedObject, const QTabletEvent&  other);
...
void delete_QTextBlockFormat(QTextBlockFormat* obj) { delete obj; }
   ...
   void writeTo(QTextBlockFormat* theWrappedObject, QDataStream&  arg__1);
   void readFrom(QTextBlockFormat* theWrappedObject, QDataStream&  arg__1);
...
inline void py_q_doSetSource(const QUrl&  name, QTextDocument::ResourceType  type = QTextDocument::UnknownResource) { QTextBrowser::doSetSource(name, type); }
...
void delete_QTextBrowser(QTextBrowser* obj) { delete obj; }
   ...
   void py_q_doSetSource(QTextBrowser* theWrappedObject, const QUrl&  name, QTextDocument::ResourceType  type = QTextDocument::UnknownResource){  (((PythonQtPublicPromoter_QTextBrowser*)theWrappedObject)->py_q_doSetSource(name, type));}
...
void delete_QTextCharFormat(QTextCharFormat* obj) { delete obj; }
   ...
   QMap<QFont::Tag , unsigned int >  fontFeatures(QTextCharFormat* theWrappedObject) const;
   ...
   QMap<QFont::Tag , float >  fontVariableAxes(QTextCharFormat* theWrappedObject) const;
   ...
   void writeTo(QTextCharFormat* theWrappedObject, QDataStream&  arg__1);
   void readFrom(QTextCharFormat* theWrappedObject, QDataStream&  arg__1);
   ...
   void setFontFeatures(QTextCharFormat* theWrappedObject, const QMap<QFont::Tag , unsigned int >&  fontFeatures);
   ...
   void setFontVariableAxes(QTextCharFormat* theWrappedObject, const QMap<QFont::Tag , float >&  fontVariableAxes);
...
void delete_QTextCursor(QTextCursor* obj) { delete obj; }
   ...
   void insertMarkdown(QTextCursor* theWrappedObject, const QString&  markdown, QTextDocument::MarkdownFeatures  features = QTextDocument::MarkdownDialectGitHub);
...
enum MetaInformation{
  DocumentTitle = QTextDocument::DocumentTitle,   DocumentUrl = QTextDocument::DocumentUrl,   CssMedia = QTextDocument::CssMedia,   FrontMatter = QTextDocument::FrontMatter};
enum Stacks{
...
void delete_QTextDocument(QTextDocument* obj) { delete obj; }
   ...
   QList<QTextFormat >  allFormats(QTextDocument* theWrappedObject) const;
   ...
   qreal  baselineOffset(QTextDocument* theWrappedObject) const;
   ...
   bool  isLayoutEnabled(QTextDocument* theWrappedObject) const;
   ...
   void setBaselineOffset(QTextDocument* theWrappedObject, qreal  baseline);
   ...
   void setLayoutEnabled(QTextDocument* theWrappedObject, bool  b);
   ...
   void setSubScriptBaseline(QTextDocument* theWrappedObject, qreal  baseline);
   void setSuperScriptBaseline(QTextDocument* theWrappedObject, qreal  baseline);
   ...
   qreal  subScriptBaseline(QTextDocument* theWrappedObject) const;
   qreal  superScriptBaseline(QTextDocument* theWrappedObject) const;
   qreal  textWidth(QTextDocument* theWrappedObject) const;
   QString  toHtml(QTextDocument* theWrappedObject) const;
...
void delete_QTextDocumentFragment(QTextDocumentFragment* obj) { delete obj; }
   ...
   QTextDocumentFragment  static_QTextDocumentFragment_fromMarkdown(const QString&  markdown, QTextDocument::MarkdownFeatures  features = QTextDocument::MarkdownDialectGitHub);
   ...
   QString  toMarkdown(QTextDocumentFragment* theWrappedObject, QTextDocument::MarkdownFeatures  features = QTextDocument::MarkdownDialectGitHub) const;
   QString  toPlainText(QTextDocumentFragment* theWrappedObject) const;
   QString  toRawText(QTextDocumentFragment* theWrappedObject) const;
