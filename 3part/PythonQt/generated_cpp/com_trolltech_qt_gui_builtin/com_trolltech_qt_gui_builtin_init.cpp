...
PythonQt::priv()->registerCPPClass("QPolygon", "", "QtGui", PythonQtCreateObject<PythonQtWrapper_QPolygon>, nullptr, module, PythonQt::Type_Add|PythonQt::Type_InplaceAdd|PythonQt::Type_Multiply|PythonQt::Type_NonZero);
...
PythonQtRegisterListTemplateConverterForKnownClass(QList, QFont::Tag);
}
