...
public:
    ...
    PythonQtShell_QSvgGenerator(QSvgGenerator::SvgVersion  version):QSvgGenerator(version),_wrapper(nullptr) {};

   ~PythonQtShell_QSvgGenerator() override;

int  devType() const override;
void initPainter(QPainter*  arg__1) const override;
...
{ public:
inline void promoted_initPainter(QPainter*  arg__1) const { this->initPainter(arg__1); }
...
inline void py_q_initPainter(QPainter*  arg__1) const { QSvgGenerator::initPainter(arg__1); }
...
enum class SvgVersion{
  SvgTiny12 = static_cast<int>(QSvgGenerator::SvgVersion::SvgTiny12),   Svg11 = static_cast<int>(QSvgGenerator::SvgVersion::Svg11)};
public Q_SLOTS:
QSvgGenerator* new_QSvgGenerator();
QSvgGenerator* new_QSvgGenerator(QSvgGenerator::SvgVersion  version);
void delete_QSvgGenerator(QSvgGenerator* obj) { delete obj; }
   ...
   void py_q_initPainter(QSvgGenerator* theWrappedObject, QPainter*  arg__1) const{  (((PythonQtPublicPromoter_QSvgGenerator*)theWrappedObject)->py_q_initPainter(arg__1));}
   ...
   QSvgGenerator::SvgVersion  svgVersion(QSvgGenerator* theWrappedObject) const;
...
void delete_QSvgRenderer(QSvgRenderer* obj) { delete obj; }
   ...
   Qt::AspectRatioMode  aspectRatioMode(QSvgRenderer* theWrappedObject) const;
   ...
   bool  isAnimationEnabled(QSvgRenderer* theWrappedObject) const;
   bool  isValid(QSvgRenderer* theWrappedObject) const;
   void setAnimationEnabled(QSvgRenderer* theWrappedObject, bool  enable);
   void setAspectRatioMode(QSvgRenderer* theWrappedObject, Qt::AspectRatioMode  mode);
   ...
   QTransform  transformForElement(QSvgRenderer* theWrappedObject, const QString&  id) const;
