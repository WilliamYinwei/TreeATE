...
PythonQt::priv()->registerCPPClass("QLocale", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QLocale>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QLocale>, module, PythonQt::Type_RichCompare);
