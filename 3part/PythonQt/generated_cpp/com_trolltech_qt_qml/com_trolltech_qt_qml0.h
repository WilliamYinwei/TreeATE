...
{
public:
    PythonQtShell_QJSEngine():QJSEngine(),_wrapper(nullptr) {};
    PythonQtShell_QJSEngine(QObject*  parent):QJSEngine(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QJSEngine() override;
...
{ Q_OBJECT
public:
Q_ENUMS(Extension ObjectOwnership )
enum Extension{
...
enum ObjectOwnership{
  CppOwnership = QJSEngine::CppOwnership,   JavaScriptOwnership = QJSEngine::JavaScriptOwnership};
public Q_SLOTS:
QJSEngine* new_QJSEngine();
QJSEngine* new_QJSEngine(QObject*  parent);
void delete_QJSEngine(QJSEngine* obj) { delete obj; }
   QJSValue  catchError(QJSEngine* theWrappedObject);
   void collectGarbage(QJSEngine* theWrappedObject);
   QJSValue  evaluate(QJSEngine* theWrappedObject, const QString&  program, const QString&  fileName = QString(), int  lineNumber = 1, QStringList*  exceptionStackTrace = nullptr);
   QJSValue  globalObject(QJSEngine* theWrappedObject) const;
   bool  hasError(QJSEngine* theWrappedObject) const;
   QJSValue  importModule(QJSEngine* theWrappedObject, const QString&  fileName);
   bool  isInterrupted(QJSEngine* theWrappedObject) const;
   ...
   QJSValue  newSymbol(QJSEngine* theWrappedObject, const QString&  name);
   QJSEngine::ObjectOwnership  static_QJSEngine_objectOwnership(QObject*  arg__1);
   bool  registerModule(QJSEngine* theWrappedObject, const QString&  moduleName, const QJSValue&  value);
   void setInterrupted(QJSEngine* theWrappedObject, bool  interrupted);
   void static_QJSEngine_setObjectOwnership(QObject*  arg__1, QJSEngine::ObjectOwnership  arg__2);
   void setUiLanguage(QJSEngine* theWrappedObject, const QString&  language);
   void throwError(QJSEngine* theWrappedObject, QJSValue::ErrorType  errorType, const QString&  message = QString());
   void throwError(QJSEngine* theWrappedObject, const QJSValue&  error);
   void throwError(QJSEngine* theWrappedObject, const QString&  message);
   QString  uiLanguage(QJSEngine* theWrappedObject) const;
};
...
class PythonQtWrapper_QJSManagedValue : public QObject
{ Q_OBJECT
public:
Q_ENUMS(Type )
enum Type{
  Undefined = QJSManagedValue::Undefined,   Boolean = QJSManagedValue::Boolean,   Number = QJSManagedValue::Number,   String = QJSManagedValue::String,   Object = QJSManagedValue::Object,   Symbol = QJSManagedValue::Symbol,   Function = QJSManagedValue::Function};
public Q_SLOTS:
QJSManagedValue* new_QJSManagedValue();
QJSManagedValue* new_QJSManagedValue(QJSValue  value, QJSEngine*  engine);
QJSManagedValue* new_QJSManagedValue(const QJSPrimitiveValue&  value, QJSEngine*  engine);
QJSManagedValue* new_QJSManagedValue(const QString&  string, QJSEngine*  engine);
QJSManagedValue* new_QJSManagedValue(const QVariant&  variant, QJSEngine*  engine);
void delete_QJSManagedValue(QJSManagedValue* obj) { delete obj; }
   QJSValue  call(QJSManagedValue* theWrappedObject, const QList<QJSValue >&  arguments = {}) const;
   QJSValue  callAsConstructor(QJSManagedValue* theWrappedObject, const QList<QJSValue >&  arguments = {}) const;
   QJSValue  callWithInstance(QJSManagedValue* theWrappedObject, const QJSValue&  instance, const QList<QJSValue >&  arguments = {}) const;
   bool  deleteProperty(QJSManagedValue* theWrappedObject, const QString&  name);
   bool  deleteProperty(QJSManagedValue* theWrappedObject, unsigned int  arrayIndex);
   QJSEngine*  engine(QJSManagedValue* theWrappedObject) const;
   bool  equals(QJSManagedValue* theWrappedObject, const QJSManagedValue&  other) const;
   bool  hasOwnProperty(QJSManagedValue* theWrappedObject, const QString&  name) const;
   bool  hasOwnProperty(QJSManagedValue* theWrappedObject, unsigned int  arrayIndex) const;
   bool  hasProperty(QJSManagedValue* theWrappedObject, const QString&  name) const;
   bool  hasProperty(QJSManagedValue* theWrappedObject, unsigned int  arrayIndex) const;
   bool  isArray(QJSManagedValue* theWrappedObject) const;
   bool  isBoolean(QJSManagedValue* theWrappedObject) const;
   bool  isDate(QJSManagedValue* theWrappedObject) const;
   bool  isError(QJSManagedValue* theWrappedObject) const;
   bool  isFunction(QJSManagedValue* theWrappedObject) const;
   bool  isInteger(QJSManagedValue* theWrappedObject) const;
   bool  isJsMetaType(QJSManagedValue* theWrappedObject) const;
   bool  isNull(QJSManagedValue* theWrappedObject) const;
   bool  isNumber(QJSManagedValue* theWrappedObject) const;
   bool  isObject(QJSManagedValue* theWrappedObject) const;
   bool  isQMetaObject(QJSManagedValue* theWrappedObject) const;
   bool  isQObject(QJSManagedValue* theWrappedObject) const;
   bool  isRegularExpression(QJSManagedValue* theWrappedObject) const;
   bool  isString(QJSManagedValue* theWrappedObject) const;
   bool  isSymbol(QJSManagedValue* theWrappedObject) const;
   bool  isUndefined(QJSManagedValue* theWrappedObject) const;
   bool  isUrl(QJSManagedValue* theWrappedObject) const;
   bool  isVariant(QJSManagedValue* theWrappedObject) const;
   QJSManagedValue  jsMetaInstantiate(QJSManagedValue* theWrappedObject, const QList<QJSValue >&  values = {}) const;
   QStringList  jsMetaMembers(QJSManagedValue* theWrappedObject) const;
   QJSManagedValue  jsMetaType(QJSManagedValue* theWrappedObject) const;
   QJSValue  property(QJSManagedValue* theWrappedObject, const QString&  name) const;
   QJSValue  property(QJSManagedValue* theWrappedObject, unsigned int  arrayIndex) const;
   QJSManagedValue  prototype(QJSManagedValue* theWrappedObject) const;
   void setProperty(QJSManagedValue* theWrappedObject, const QString&  name, const QJSValue&  value);
   void setProperty(QJSManagedValue* theWrappedObject, unsigned int  arrayIndex, const QJSValue&  value);
   void setPrototype(QJSManagedValue* theWrappedObject, const QJSManagedValue&  prototype);
   bool  strictlyEquals(QJSManagedValue* theWrappedObject, const QJSManagedValue&  other) const;
   bool  toBoolean(QJSManagedValue* theWrappedObject) const;
   QDateTime  toDateTime(QJSManagedValue* theWrappedObject) const;
   int  toInteger(QJSManagedValue* theWrappedObject) const;
   QJSValue  toJSValue(QJSManagedValue* theWrappedObject) const;
   double  toNumber(QJSManagedValue* theWrappedObject) const;
   QJSPrimitiveValue  toPrimitive(QJSManagedValue* theWrappedObject) const;
   const QMetaObject*  toQMetaObject(QJSManagedValue* theWrappedObject) const;
   QObject*  toQObject(QJSManagedValue* theWrappedObject) const;
   QRegularExpression  toRegularExpression(QJSManagedValue* theWrappedObject) const;
   QString  toString(QJSManagedValue* theWrappedObject) const;
   QUrl  toUrl(QJSManagedValue* theWrappedObject) const;
   QVariant  toVariant(QJSManagedValue* theWrappedObject) const;
   QJSManagedValue::Type  type(QJSManagedValue* theWrappedObject) const;
    QString py_toString(QJSManagedValue*);
    bool __nonzero__(QJSManagedValue* obj) { return !obj->isNull(); }
};
...
class PythonQtShell_QJSPrimitiveNull : public QJSPrimitiveNull
{
public:
    PythonQtShell_QJSPrimitiveNull():QJSPrimitiveNull(),_wrapper(nullptr) {};

   ~PythonQtShell_QJSPrimitiveNull();


  PythonQtInstanceWrapper* _wrapper;
};

class PythonQtWrapper_QJSPrimitiveNull : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QJSPrimitiveNull* new_QJSPrimitiveNull();
void delete_QJSPrimitiveNull(QJSPrimitiveNull* obj) { delete obj; }
};
...
class PythonQtShell_QJSPrimitiveUndefined : public QJSPrimitiveUndefined
{
public:
    PythonQtShell_QJSPrimitiveUndefined():QJSPrimitiveUndefined(),_wrapper(nullptr) {};

   ~PythonQtShell_QJSPrimitiveUndefined();


  PythonQtInstanceWrapper* _wrapper;
};

class PythonQtWrapper_QJSPrimitiveUndefined : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QJSPrimitiveUndefined* new_QJSPrimitiveUndefined();
void delete_QJSPrimitiveUndefined(QJSPrimitiveUndefined* obj) { delete obj; }
};
...
class PythonQtWrapper_QJSPrimitiveValue : public QObject
{ Q_OBJECT
public:
Q_ENUMS(Type )
enum Type{
  Undefined = QJSPrimitiveValue::Undefined,   Null = QJSPrimitiveValue::Null,   Boolean = QJSPrimitiveValue::Boolean,   Integer = QJSPrimitiveValue::Integer,   Double = QJSPrimitiveValue::Double,   String = QJSPrimitiveValue::String};
public Q_SLOTS:
QJSPrimitiveValue* new_QJSPrimitiveValue();
QJSPrimitiveValue* new_QJSPrimitiveValue(QJSPrimitiveNull  null);
QJSPrimitiveValue* new_QJSPrimitiveValue(QJSPrimitiveUndefined  undefined);
QJSPrimitiveValue* new_QJSPrimitiveValue(QMetaType  type);
QJSPrimitiveValue* new_QJSPrimitiveValue(QString  string);
QJSPrimitiveValue* new_QJSPrimitiveValue(bool  value);
QJSPrimitiveValue* new_QJSPrimitiveValue(const QMetaType  type, const void*  value);
QJSPrimitiveValue* new_QJSPrimitiveValue(const QVariant&  variant);
QJSPrimitiveValue* new_QJSPrimitiveValue(double  value);
QJSPrimitiveValue* new_QJSPrimitiveValue(int  value);
void delete_QJSPrimitiveValue(QJSPrimitiveValue* obj) { delete obj; }
   const void*  constData(QJSPrimitiveValue* theWrappedObject) const;
   void*  data(QJSPrimitiveValue* theWrappedObject);
   const void*  data(QJSPrimitiveValue* theWrappedObject) const;
   bool  equals(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  other) const;
   QMetaType  metaType(QJSPrimitiveValue* theWrappedObject) const;
   bool  __ne__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   QJSPrimitiveValue  __mod__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   QJSPrimitiveValue  __mul__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   QJSPrimitiveValue  __add__(QJSPrimitiveValue* theWrappedObject);
   QJSPrimitiveValue  __add__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   QJSPrimitiveValue*  operator_increment(QJSPrimitiveValue* theWrappedObject);
   QJSPrimitiveValue  __sub__(QJSPrimitiveValue* theWrappedObject);
   QJSPrimitiveValue  __sub__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   QJSPrimitiveValue*  operator_decrement(QJSPrimitiveValue* theWrappedObject);
   QJSPrimitiveValue  __div__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   bool  __lt__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   bool  __le__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   bool  __eq__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   bool  __gt__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   bool  __ge__(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  rhs);
   bool  strictlyEquals(QJSPrimitiveValue* theWrappedObject, const QJSPrimitiveValue&  other) const;
   bool  toBoolean(QJSPrimitiveValue* theWrappedObject) const;
   double  toDouble(QJSPrimitiveValue* theWrappedObject) const;
   int  toInteger(QJSPrimitiveValue* theWrappedObject) const;
   QString  toString(QJSPrimitiveValue* theWrappedObject) const;
   QVariant  toVariant(QJSPrimitiveValue* theWrappedObject) const;
   QJSPrimitiveValue::Type  type(QJSPrimitiveValue* theWrappedObject) const;
    QString py_toString(QJSPrimitiveValue*);
};
...
{ Q_OBJECT
public:
Q_ENUMS(ErrorType ObjectConversionBehavior SpecialValue )
enum ErrorType{
...
enum ObjectConversionBehavior{
  ConvertJSObjects = QJSValue::ConvertJSObjects,   RetainJSObjects = QJSValue::RetainJSObjects};
enum SpecialValue{
...
void delete_QJSValue(QJSValue* obj) { delete obj; }
   QJSValue  call(QJSValue* theWrappedObject, const QList<QJSValue >&  args = QJSValueList()) const;
   QJSValue  callAsConstructor(QJSValue* theWrappedObject, const QList<QJSValue >&  args = QJSValueList()) const;
   QJSValue  callWithInstance(QJSValue* theWrappedObject, const QJSValue&  instance, const QList<QJSValue >&  args = QJSValueList()) const;
   ...
   bool  isUrl(QJSValue* theWrappedObject) const;
   bool  isVariant(QJSValue* theWrappedObject) const;
   void writeTo(QJSValue* theWrappedObject, QDataStream&  arg__1);
   QJSValue*  operator_assign(QJSValue* theWrappedObject, const QJSValue&  other);
   void readFrom(QJSValue* theWrappedObject, QDataStream&  arg__1);
   ...
   QJSPrimitiveValue  toPrimitive(QJSValue* theWrappedObject) const;
   ...
   QVariant  toVariant(QJSValue* theWrappedObject, QJSValue::ObjectConversionBehavior  behavior) const;
...
{
public:
    PythonQtShell_QQmlAbstractUrlInterceptor():QQmlAbstractUrlInterceptor(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlAbstractUrlInterceptor() override;
...
{
public:
    PythonQtShell_QQmlApplicationEngine(QAnyStringView  uri, QAnyStringView  typeName, QObject*  parent = nullptr):QQmlApplicationEngine(uri, typeName, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlApplicationEngine(QObject*  parent = nullptr):QQmlApplicationEngine(parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlApplicationEngine(const QString&  filePath, QObject*  parent = nullptr):QQmlApplicationEngine(filePath, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlApplicationEngine(const QUrl&  url, QObject*  parent = nullptr):QQmlApplicationEngine(url, parent),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlApplicationEngine() override;
...
public:
public Q_SLOTS:
QQmlApplicationEngine* new_QQmlApplicationEngine(QAnyStringView  uri, QAnyStringView  typeName, QObject*  parent = nullptr);
...
{
public:
    PythonQtShell_QQmlComponent(QObject*  parent = nullptr):QQmlComponent(parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  arg__1, QObject*  parent = nullptr):QQmlComponent(arg__1, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  arg__1, const QString&  fileName, QObject*  parent = nullptr):QQmlComponent(arg__1, fileName, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  arg__1, const QString&  fileName, QQmlComponent::CompilationMode  mode, QObject*  parent = nullptr):QQmlComponent(arg__1, fileName, mode, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  arg__1, const QUrl&  url, QObject*  parent = nullptr):QQmlComponent(arg__1, url, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  arg__1, const QUrl&  url, QQmlComponent::CompilationMode  mode, QObject*  parent = nullptr):QQmlComponent(arg__1, url, mode, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  engine, QAnyStringView  uri, QAnyStringView  typeName, QObject*  parent = nullptr):QQmlComponent(engine, uri, typeName, parent),_wrapper(nullptr) {};
    PythonQtShell_QQmlComponent(QQmlEngine*  engine, QAnyStringView  uri, QAnyStringView  typeName, QQmlComponent::CompilationMode  mode, QObject*  parent = nullptr):QQmlComponent(engine, uri, typeName, mode, parent),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlComponent() override;

QObject*  beginCreate(QQmlContext*  arg__1) override;
void childEvent(QChildEvent*  event) override;
void completeCreate() override;
QObject*  create(QQmlContext*  context = nullptr) override;
void customEvent(QEvent*  event) override;
bool  event(QEvent*  event) override;
bool  eventFilter(QObject*  watched, QEvent*  event) override;
void timerEvent(QTimerEvent*  event) override;
...
{ public:
inline QObject*  promoted_createObject(QObject*  parent = nullptr, const QMap<QString , QVariant >&  properties = {}) { return this->createObject(parent, properties); }
...
QQmlComponent* new_QQmlComponent(QQmlEngine*  engine, QAnyStringView  uri, QAnyStringView  typeName, QObject*  parent = nullptr);
QQmlComponent* new_QQmlComponent(QQmlEngine*  engine, QAnyStringView  uri, QAnyStringView  typeName, QQmlComponent::CompilationMode  mode, QObject*  parent = nullptr);
void delete_QQmlComponent(QQmlComponent* obj) { delete obj; }
   ...
   QObject*  createObject(QQmlComponent* theWrappedObject, QObject*  parent = nullptr, const QMap<QString , QVariant >&  properties = {});
   QObject*  createWithInitialProperties(QQmlComponent* theWrappedObject, const QMap<QString , QVariant >&  initialProperties, QQmlContext*  context = nullptr);
   QQmlContext*  creationContext(QQmlComponent* theWrappedObject) const;
   QQmlEngine*  engine(QQmlComponent* theWrappedObject) const;
   QString  errorString(QQmlComponent* theWrappedObject) const;
   QList<QQmlError >  errors(QQmlComponent* theWrappedObject) const;
   bool  isBound(QQmlComponent* theWrappedObject) const;
   ...
   void setInitialProperties(QQmlComponent* theWrappedObject, QObject*  component, const QMap<QString , QVariant >&  properties);
...
{
public:
    PythonQtShell_QQmlContext(QQmlContext*  parent, QObject*  objParent = nullptr):QQmlContext(parent, objParent),_wrapper(nullptr) {};
    PythonQtShell_QQmlContext(QQmlEngine*  parent, QObject*  objParent = nullptr):QQmlContext(parent, objParent),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlContext() override;
...
void delete_QQmlContext(QQmlContext* obj) { delete obj; }
   ...
   QList<QQmlContext* >  childContexts(QQmlContext* theWrappedObject) const;
   ...
   QObject*  findObjectRecursively(QQmlContext* theWrappedObject, const QString&  id) const;
   QList<QObject* >  findObjectsRecursively(QQmlContext* theWrappedObject, const QString&  id) const;
   QJSValue  importedScript(QQmlContext* theWrappedObject, const QString&  name) const;
   bool  isValid(QQmlContext* theWrappedObject) const;
   QString  nameForObject(QQmlContext* theWrappedObject, const QObject*  arg__1) const;
   QObject*  objectForName(QQmlContext* theWrappedObject, const QString&  arg__1) const;
   QQmlContext*  parentContext(QQmlContext* theWrappedObject) const;
   QUrl  resolvedUrl(QQmlContext* theWrappedObject, const QUrl&  arg__1) const;
...
void delete_QQmlDebuggingEnabler(QQmlDebuggingEnabler* obj) { delete obj; }
   ...
   void static_QQmlDebuggingEnabler_enableDebugging(bool  printWarning);
...
{
public:
    PythonQtShell_QQmlEngine(QObject*  p = nullptr):QQmlEngine(p),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlEngine() override;
...
void delete_QQmlEngine(QQmlEngine* obj) { delete obj; }
   ...
   bool  addNamedBundle(QQmlEngine* theWrappedObject, const QString&  arg__1, const QString&  arg__2);
   void addPluginPath(QQmlEngine* theWrappedObject, const QString&  dir);
   void addUrlInterceptor(QQmlEngine* theWrappedObject, QQmlAbstractUrlInterceptor*  urlInterceptor);
   QUrl  baseUrl(QQmlEngine* theWrappedObject) const;
   void captureProperty(QQmlEngine* theWrappedObject, QObject*  object, const QMetaProperty&  property) const;
   void clearComponentCache(QQmlEngine* theWrappedObject);
   void clearSingletons(QQmlEngine* theWrappedObject);
   ...
   QUrl  interceptUrl(QQmlEngine* theWrappedObject, const QUrl&  url, QQmlAbstractUrlInterceptor::DataType  type) const;
   void markCurrentFunctionAsTranslationBinding(QQmlEngine* theWrappedObject);
   ...
   void removeUrlInterceptor(QQmlEngine* theWrappedObject, QQmlAbstractUrlInterceptor*  urlInterceptor);
   ...
   QList<QQmlAbstractUrlInterceptor* >  urlInterceptors(QQmlEngine* theWrappedObject) const;
};
...
void delete_QQmlError(QQmlError* obj) { delete obj; }
   ...
   bool  __eq__(QQmlError* theWrappedObject, const QQmlError&  b);
   ...
   void swap(QQmlError* theWrappedObject, QQmlError&  other);
...
{
public:
    PythonQtShell_QQmlExpression():QQmlExpression(),_wrapper(nullptr) {};
    PythonQtShell_QQmlExpression(QQmlContext*  arg__1, QObject*  arg__2, const QString&  arg__3, QObject*  arg__4 = nullptr):QQmlExpression(arg__1, arg__2, arg__3, arg__4),_wrapper(nullptr) {};
    PythonQtShell_QQmlExpression(const QQmlScriptString&  arg__1, QQmlContext*  arg__2 = nullptr, QObject*  arg__3 = nullptr, QObject*  arg__4 = nullptr):QQmlExpression(arg__1, arg__2, arg__3, arg__4),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlExpression() override;
...
{
public:
    PythonQtShell_QQmlExtensionInterface():QQmlExtensionInterface(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlExtensionInterface() override;
...
{
public:
    PythonQtShell_QQmlExtensionPlugin(QObject*  parent = nullptr):QQmlExtensionPlugin(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlExtensionPlugin() override;
...
inline void py_q_unregisterTypes() { QQmlExtensionPlugin::unregisterTypes(); }
};
...
void delete_QQmlExtensionPlugin(QQmlExtensionPlugin* obj) { delete obj; }
   ...
   void unregisterTypes(QQmlExtensionPlugin* theWrappedObject);
   void py_q_unregisterTypes(QQmlExtensionPlugin* theWrappedObject){  (((PythonQtPublicPromoter_QQmlExtensionPlugin*)theWrappedObject)->py_q_unregisterTypes());}
};
...
QQmlFile* new_QQmlFile(QQmlEngine*  engine, const QString&  url);
QQmlFile* new_QQmlFile(QQmlEngine*  engine, const QUrl&  url);
void delete_QQmlFile(QQmlFile* obj) { delete obj; }
   void clear(QQmlFile* theWrappedObject);
   void clear(QQmlFile* theWrappedObject, QObject*  object);
...
{
public:
    PythonQtShell_QQmlFileSelector(QQmlEngine*  engine, QObject*  parent = nullptr):QQmlFileSelector(engine, parent),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlFileSelector() override;
...
{
public:
    PythonQtShell_QQmlIncubationController():QQmlIncubationController(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlIncubationController() override;
...
{
public:
    PythonQtShell_QQmlIncubator(QQmlIncubator::IncubationMode  arg__1 = QQmlIncubator::Asynchronous):QQmlIncubator(arg__1),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlIncubator() override;
...
void delete_QQmlIncubator(QQmlIncubator* obj) { delete obj; }
   ...
   void setInitialProperties(QQmlIncubator* theWrappedObject, const QMap<QString , QVariant >&  initialProperties);
...
QQmlListReference* new_QQmlListReference(QObject*  o, const char*  property);
QQmlListReference* new_QQmlListReference(QObject*  o, const char*  property, QQmlEngine*  engine);
QQmlListReference* new_QQmlListReference(const QQmlListReference&  arg__1);
QQmlListReference* new_QQmlListReference(const QVariant&  variant);
QQmlListReference* new_QQmlListReference(const QVariant&  variant, QQmlEngine*  engine);
void delete_QQmlListReference(QQmlListReference* obj) { delete obj; }
   ...
   QObject*  at(QQmlListReference* theWrappedObject, qsizetype  arg__1) const;
   ...
   bool  canRemoveLast(QQmlListReference* theWrappedObject) const;
   bool  canReplace(QQmlListReference* theWrappedObject) const;
   bool  clear(QQmlListReference* theWrappedObject) const;
   qsizetype  count(QQmlListReference* theWrappedObject) const;
   ...
   bool  __eq__(QQmlListReference* theWrappedObject, const QQmlListReference&  other) const;
   bool  removeLast(QQmlListReference* theWrappedObject) const;
   bool  replace(QQmlListReference* theWrappedObject, qsizetype  arg__1, QObject*  arg__2) const;
   qsizetype  size(QQmlListReference* theWrappedObject) const;
...
{
public:
    PythonQtShell_QQmlNetworkAccessManagerFactory():QQmlNetworkAccessManagerFactory(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlNetworkAccessManagerFactory() override;
...
{
public:
    PythonQtShell_QQmlParserStatus():QQmlParserStatus(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlParserStatus() override;
...
void delete_QQmlProperty(QQmlProperty* obj) { delete obj; }
   ...
   bool  isBindable(QQmlProperty* theWrappedObject) const;
   ...
   QMetaType  propertyMetaType(QQmlProperty* theWrappedObject) const;
   ...
   void swap(QQmlProperty* theWrappedObject, QQmlProperty&  other);
...
{
public:
    PythonQtShell_QQmlPropertyMap(QObject*  parent = nullptr):QQmlPropertyMap(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlPropertyMap() override;
...
void delete_QQmlPropertyMap(QQmlPropertyMap* obj) { delete obj; }
   ...
   QQmlPropertyMap*  static_QQmlPropertyMap_create(QObject*  parent = nullptr);
   void freeze(QQmlPropertyMap* theWrappedObject);
   void insert(QQmlPropertyMap* theWrappedObject, const QHash<QString , QVariant >&  values);
...
{
public:
    PythonQtShell_QQmlPropertyValueSource():QQmlPropertyValueSource(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlPropertyValueSource() override;
...
{
public:
    PythonQtShell_QQmlTypesExtensionInterface():QQmlTypesExtensionInterface(),_wrapper(nullptr) {};

   ~PythonQtShell_QQmlTypesExtensionInterface() override;
