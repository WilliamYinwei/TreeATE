...
PythonQt::priv()->registerCPPClass("QQuickGraphicsConfiguration", "", "QtQuick", PythonQtCreateObject<PythonQtWrapper_QQuickGraphicsConfiguration>, nullptr, module, 0);
PythonQt::priv()->registerClass(&QQuickImageProvider::staticMetaObject, "QtQuick", PythonQtCreateObject<PythonQtWrapper_QQuickImageProvider>, nullptr, module, 0);
...
PythonQt::priv()->registerCPPClass("QQuickRenderTarget", "", "QtQuick", PythonQtCreateObject<PythonQtWrapper_QQuickRenderTarget>, nullptr, module, PythonQt::Type_NonZero|PythonQt::Type_RichCompare);
...
PythonQt::priv()->registerCPPClass("QQuickWindow::GraphicsStateInfo", "", "QtQuick", PythonQtCreateObject<PythonQtWrapper_QQuickWindow__GraphicsStateInfo>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QQuickWindow__GraphicsStateInfo>, module, 0);
...
PythonQt::priv()->registerCPPClass("QSGTextNode", "QSGTransformNode", "QtQuick", PythonQtCreateObject<PythonQtWrapper_QSGTextNode>, nullptr, module, 0);
