...
{ public:
inline void promoted_geometryChange(const QRectF&  newGeometry, const QRectF&  oldGeometry) { this->geometryChange(newGeometry, oldGeometry); }
...
inline void py_q_geometryChange(const QRectF&  newGeometry, const QRectF&  oldGeometry) { QQuickFramebufferObject::geometryChange(newGeometry, oldGeometry); }
...
void delete_QQuickFramebufferObject(QQuickFramebufferObject* obj) { delete obj; }
   ...
   void py_q_geometryChange(QQuickFramebufferObject* theWrappedObject, const QRectF&  newGeometry, const QRectF&  oldGeometry){  (((PythonQtPublicPromoter_QQuickFramebufferObject*)theWrappedObject)->py_q_geometryChange(newGeometry, oldGeometry));}
...
class PythonQtWrapper_QQuickGraphicsConfiguration : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QQuickGraphicsConfiguration* new_QQuickGraphicsConfiguration();
QQuickGraphicsConfiguration* new_QQuickGraphicsConfiguration(const QQuickGraphicsConfiguration&  other);
void delete_QQuickGraphicsConfiguration(QQuickGraphicsConfiguration* obj) { delete obj; }
   QList<QByteArray >  deviceExtensions(QQuickGraphicsConfiguration* theWrappedObject) const;
   bool  isAutomaticPipelineCacheEnabled(QQuickGraphicsConfiguration* theWrappedObject) const;
   bool  isDebugLayerEnabled(QQuickGraphicsConfiguration* theWrappedObject) const;
   bool  isDebugMarkersEnabled(QQuickGraphicsConfiguration* theWrappedObject) const;
   bool  isDepthBufferEnabledFor2D(QQuickGraphicsConfiguration* theWrappedObject) const;
   QQuickGraphicsConfiguration*  operator_assign(QQuickGraphicsConfiguration* theWrappedObject, const QQuickGraphicsConfiguration&  other);
   QString  pipelineCacheLoadFile(QQuickGraphicsConfiguration* theWrappedObject) const;
   QString  pipelineCacheSaveFile(QQuickGraphicsConfiguration* theWrappedObject) const;
   QList<QByteArray >  static_QQuickGraphicsConfiguration_preferredInstanceExtensions();
   bool  prefersSoftwareDevice(QQuickGraphicsConfiguration* theWrappedObject) const;
   void setAutomaticPipelineCache(QQuickGraphicsConfiguration* theWrappedObject, bool  enable);
   void setDebugLayer(QQuickGraphicsConfiguration* theWrappedObject, bool  enable);
   void setDebugMarkers(QQuickGraphicsConfiguration* theWrappedObject, bool  enable);
   void setDepthBufferFor2D(QQuickGraphicsConfiguration* theWrappedObject, bool  enable);
   void setDeviceExtensions(QQuickGraphicsConfiguration* theWrappedObject, const QList<QByteArray >&  extensions);
   void setPipelineCacheLoadFile(QQuickGraphicsConfiguration* theWrappedObject, const QString&  filename);
   void setPipelineCacheSaveFile(QQuickGraphicsConfiguration* theWrappedObject, const QString&  filename);
   void setPreferSoftwareDevice(QQuickGraphicsConfiguration* theWrappedObject, bool  enable);
   void setTimestamps(QQuickGraphicsConfiguration* theWrappedObject, bool  enable);
   bool  timestampsEnabled(QQuickGraphicsConfiguration* theWrappedObject) const;
    QString py_toString(QQuickGraphicsConfiguration*);
};
...
inline void py_q_geometryChange(const QRectF&  newGeometry, const QRectF&  oldGeometry) { QQuickItem::geometryChange(newGeometry, oldGeometry); }
...
Q_ENUMS(Flag )
enum Flag{
  ItemClipsChildrenToShape = QQuickItem::ItemClipsChildrenToShape,   ItemAcceptsInputMethod = QQuickItem::ItemAcceptsInputMethod,   ItemIsFocusScope = QQuickItem::ItemIsFocusScope,   ItemHasContents = QQuickItem::ItemHasContents,   ItemAcceptsDrops = QQuickItem::ItemAcceptsDrops,   ItemIsViewport = QQuickItem::ItemIsViewport,   ItemObservesViewport = QQuickItem::ItemObservesViewport};
public Q_SLOTS:
...
void delete_QQuickItem(QQuickItem* obj) { delete obj; }
   ...
   void dumpItemTree(QQuickItem* theWrappedObject) const;
   void ensurePolished(QQuickItem* theWrappedObject);
   ...
   Qt::FocusPolicy  focusPolicy(QQuickItem* theWrappedObject) const;
   void forceActiveFocus(QQuickItem* theWrappedObject);
   void forceActiveFocus(QQuickItem* theWrappedObject, Qt::FocusReason  reason);
   void geometryChange(QQuickItem* theWrappedObject, const QRectF&  newGeometry, const QRectF&  oldGeometry);
   void py_q_geometryChange(QQuickItem* theWrappedObject, const QRectF&  newGeometry, const QRectF&  oldGeometry){  (((PythonQtPublicPromoter_QQuickItem*)theWrappedObject)->py_q_geometryChange(newGeometry, oldGeometry));}
   ...
   void grabTouchPoints(QQuickItem* theWrappedObject, const QList<int >&  ids);
   ...
   QPointF  mapFromGlobal(QQuickItem* theWrappedObject, qreal  x, qreal  y) const;
   QPointF  mapFromItem(QQuickItem* theWrappedObject, const QQuickItem*  item, const QPointF&  point) const;
   QRectF  mapFromItem(QQuickItem* theWrappedObject, const QQuickItem*  item, const QRectF&  rect) const;
   QPointF  mapFromItem(QQuickItem* theWrappedObject, const QQuickItem*  item, qreal  x, qreal  y);
   QRectF  mapFromItem(QQuickItem* theWrappedObject, const QQuickItem*  item, qreal  x, qreal  y, qreal  width, qreal  height) const;
   ...
   QPointF  mapToGlobal(QQuickItem* theWrappedObject, qreal  x, qreal  y) const;
   QPointF  mapToItem(QQuickItem* theWrappedObject, const QQuickItem*  item, const QPointF&  point) const;
   QRectF  mapToItem(QQuickItem* theWrappedObject, const QQuickItem*  item, const QRectF&  rect) const;
   QPointF  mapToItem(QQuickItem* theWrappedObject, const QQuickItem*  item, qreal  x, qreal  y);
   QRectF  mapToItem(QQuickItem* theWrappedObject, const QQuickItem*  item, qreal  x, qreal  y, qreal  width, qreal  height) const;
   ...
   void setFocusPolicy(QQuickItem* theWrappedObject, Qt::FocusPolicy  policy);
   ...
   QQuickItem*  viewportItem(QQuickItem* theWrappedObject) const;
...
void delete_QQuickItemGrabResult(QQuickItemGrabResult* obj) { delete obj; }
   ...
   bool  saveToFile(QQuickItemGrabResult* theWrappedObject, const QUrl&  fileName) const;
...
void delete_QQuickRenderControl(QQuickRenderControl* obj) { delete obj; }
   void beginFrame(QQuickRenderControl* theWrappedObject);
   void endFrame(QQuickRenderControl* theWrappedObject);
   bool  initialize(QQuickRenderControl* theWrappedObject);
   ...
   int  samples(QQuickRenderControl* theWrappedObject) const;
   void setSamples(QQuickRenderControl* theWrappedObject, int  sampleCount);
   bool  sync(QQuickRenderControl* theWrappedObject);
   QQuickWindow*  window(QQuickRenderControl* theWrappedObject) const;
};
...
class PythonQtWrapper_QQuickRenderTarget : public QObject
{ Q_OBJECT
public:
Q_ENUMS(Flag )
enum class Flag{
  MultisampleResolve = static_cast<int>(QQuickRenderTarget::Flag::MultisampleResolve)};
public Q_SLOTS:
QQuickRenderTarget* new_QQuickRenderTarget();
QQuickRenderTarget* new_QQuickRenderTarget(const QQuickRenderTarget&  other);
void delete_QQuickRenderTarget(QQuickRenderTarget* obj) { delete obj; }
   qreal  devicePixelRatio(QQuickRenderTarget* theWrappedObject) const;
   QQuickRenderTarget  static_QQuickRenderTarget_fromOpenGLRenderBuffer(uint  renderbufferId, const QSize&  pixelSize, int  sampleCount = 1);
   QQuickRenderTarget  static_QQuickRenderTarget_fromOpenGLTexture(uint  textureId, const QSize&  pixelSize, int  sampleCount = 1);
   QQuickRenderTarget  static_QQuickRenderTarget_fromOpenGLTexture(uint  textureId, uint  format, const QSize&  pixelSize, int  sampleCount = 1);
   QQuickRenderTarget  static_QQuickRenderTarget_fromPaintDevice(QPaintDevice*  device);
   bool  isNull(QQuickRenderTarget* theWrappedObject) const;
   bool  mirrorVertically(QQuickRenderTarget* theWrappedObject) const;
   bool  __ne__(QQuickRenderTarget* theWrappedObject, const QQuickRenderTarget&  rhs);
   QQuickRenderTarget*  operator_assign(QQuickRenderTarget* theWrappedObject, const QQuickRenderTarget&  other);
   bool  __eq__(QQuickRenderTarget* theWrappedObject, const QQuickRenderTarget&  rhs);
   void setDevicePixelRatio(QQuickRenderTarget* theWrappedObject, qreal  ratio);
   void setMirrorVertically(QQuickRenderTarget* theWrappedObject, bool  enable);
    bool __nonzero__(QQuickRenderTarget* obj) { return !obj->isNull(); }
};
...
void delete_QQuickTextDocument(QQuickTextDocument* obj) { delete obj; }
   QString  errorString(QQuickTextDocument* theWrappedObject) const;
   bool  isModified(QQuickTextDocument* theWrappedObject) const;
   void save(QQuickTextDocument* theWrappedObject);
   void saveAs(QQuickTextDocument* theWrappedObject, const QUrl&  url);
   void setModified(QQuickTextDocument* theWrappedObject, bool  modified);
   void setSource(QQuickTextDocument* theWrappedObject, const QUrl&  url);
   void setTextDocument(QQuickTextDocument* theWrappedObject, QTextDocument*  document);
   QUrl  source(QQuickTextDocument* theWrappedObject) const;
   QQuickTextDocument::Status  status(QQuickTextDocument* theWrappedObject) const;
...
{
public:
    PythonQtShell_QQuickView(QAnyStringView  uri, QAnyStringView  typeName, QWindow*  parent = nullptr):QQuickView(uri, typeName, parent),_wrapper(nullptr) {};
...
public:
public Q_SLOTS:
QQuickView* new_QQuickView(QAnyStringView  uri, QAnyStringView  typeName, QWindow*  parent = nullptr);
...
{
public:
    PythonQtShell_QQuickWidget(QAnyStringView  uri, QAnyStringView  typeName, QWidget*  parent = nullptr):QQuickWidget(uri, typeName, parent),_wrapper(nullptr) {};
...
public:
public Q_SLOTS:
QQuickWidget* new_QQuickWidget(QAnyStringView  uri, QAnyStringView  typeName, QWidget*  parent = nullptr);
...
inline void promoted_wheelEvent(QWheelEvent*  arg__1) { this->wheelEvent(arg__1); }
inline void py_q_closeEvent(QCloseEvent*  arg__1) { QQuickWindow::closeEvent(arg__1); }
...
inline void py_q_tabletEvent(QTabletEvent*  arg__1) { QQuickWindow::tabletEvent(arg__1); }
...
void delete_QQuickWindow(QQuickWindow* obj) { delete obj; }
   ...
   void beginExternalCommands(QQuickWindow* theWrappedObject);
   void py_q_closeEvent(QQuickWindow* theWrappedObject, QCloseEvent*  arg__1){  (((PythonQtPublicPromoter_QQuickWindow*)theWrappedObject)->py_q_closeEvent(arg__1));}
   ...
   QSGTextNode*  createTextNode(QQuickWindow* theWrappedObject) const;
   ...
   void endExternalCommands(QQuickWindow* theWrappedObject);
   ...
   QSGRendererInterface::GraphicsApi  static_QQuickWindow_graphicsApi();
   QQuickGraphicsConfiguration  graphicsConfiguration(QQuickWindow* theWrappedObject) const;
   const QQuickWindow::GraphicsStateInfo*  graphicsStateInfo(QQuickWindow* theWrappedObject);
   ...
   bool  isPersistentGraphics(QQuickWindow* theWrappedObject) const;
   ...
   QQuickRenderTarget  renderTarget(QQuickWindow* theWrappedObject) const;
   ...
   void static_QQuickWindow_setGraphicsApi(QSGRendererInterface::GraphicsApi  api);
   void setGraphicsConfiguration(QQuickWindow* theWrappedObject, const QQuickGraphicsConfiguration&  config);
   void setPersistentGraphics(QQuickWindow* theWrappedObject, bool  persistent);
   void setPersistentSceneGraph(QQuickWindow* theWrappedObject, bool  persistent);
   void setRenderTarget(QQuickWindow* theWrappedObject, const QQuickRenderTarget&  target);
   ...
   void py_q_tabletEvent(QQuickWindow* theWrappedObject, QTabletEvent*  arg__1){  (((PythonQtPublicPromoter_QQuickWindow*)theWrappedObject)->py_q_tabletEvent(arg__1));}
...
class PythonQtShell_QQuickWindow__GraphicsStateInfo : public QQuickWindow::GraphicsStateInfo
{
public:
    PythonQtShell_QQuickWindow__GraphicsStateInfo():QQuickWindow::GraphicsStateInfo(),_wrapper(nullptr) {};
...
int  py_get_currentFrameSlot(QQuickWindow::GraphicsStateInfo* theWrappedObject){ return theWrappedObject->currentFrameSlot; }
void py_set_framesInFlight(QQuickWindow::GraphicsStateInfo* theWrappedObject, int  framesInFlight){ theWrappedObject->framesInFlight = framesInFlight; }
int  py_get_framesInFlight(QQuickWindow::GraphicsStateInfo* theWrappedObject){ return theWrappedObject->framesInFlight; }
};
...
void delete_QSGGeometry(QSGGeometry* obj) { delete obj; }
   ...
   void setIndexCount(QSGGeometry* theWrappedObject, int  count);
   ...
   void setVertexCount(QSGGeometry* theWrappedObject, int  count);
...
{ public:
inline QSGTexture::AnisotropyLevel  py_q_anisotropyLevel() const { return this->anisotropyLevel(); }
...
inline void py_q_setAnisotropyLevel(QSGTexture::AnisotropyLevel  level) { this->setAnisotropyLevel(level); }
...
void delete_QSGImageNode(QSGImageNode* obj) { delete obj; }
   QSGTexture::AnisotropyLevel  anisotropyLevel(QSGImageNode* theWrappedObject) const;
   QSGTexture::AnisotropyLevel  py_q_anisotropyLevel(QSGImageNode* theWrappedObject) const{  return (((PythonQtPublicPromoter_QSGImageNode*)theWrappedObject)->py_q_anisotropyLevel());}
   ...
   void setAnisotropyLevel(QSGImageNode* theWrappedObject, QSGTexture::AnisotropyLevel  level);
   void py_q_setAnisotropyLevel(QSGImageNode* theWrappedObject, QSGTexture::AnisotropyLevel  level){  (((PythonQtPublicPromoter_QSGImageNode*)theWrappedObject)->py_q_setAnisotropyLevel(level));}
