...
class PythonQtShell_QDeadlineTimer : public QDeadlineTimer
{
public:
    PythonQtShell_QDeadlineTimer():QDeadlineTimer(),_wrapper(nullptr) {};
    PythonQtShell_QDeadlineTimer(QDeadlineTimer::ForeverConstant  arg__1, Qt::TimerType  type_ = Qt::CoarseTimer):QDeadlineTimer(arg__1, type_),_wrapper(nullptr) {};
    PythonQtShell_QDeadlineTimer(Qt::TimerType  type_):QDeadlineTimer(type_),_wrapper(nullptr) {};
    PythonQtShell_QDeadlineTimer(qint64  msecs, Qt::TimerType  type = Qt::CoarseTimer):QDeadlineTimer(msecs, type),_wrapper(nullptr) {};

   ~PythonQtShell_QDeadlineTimer();
...
enum class ForeverConstant{
  Forever = static_cast<int>(QDeadlineTimer::ForeverConstant::Forever)};
public Q_SLOTS:
QDeadlineTimer* new_QDeadlineTimer();
QDeadlineTimer* new_QDeadlineTimer(QDeadlineTimer::ForeverConstant  arg__1, Qt::TimerType  type_ = Qt::CoarseTimer);
QDeadlineTimer* new_QDeadlineTimer(Qt::TimerType  type_);
...
void delete_QDeadlineTimer(QDeadlineTimer* obj) { delete obj; }
   ...
   bool  __ne__(QDeadlineTimer* theWrappedObject, const QDeadlineTimer&  rhs);
   ...
   bool  __lt__(QDeadlineTimer* theWrappedObject, const QDeadlineTimer&  rhs);
   bool  __le__(QDeadlineTimer* theWrappedObject, const QDeadlineTimer&  rhs);
   bool  __eq__(QDeadlineTimer* theWrappedObject, const QDeadlineTimer&  rhs);
   bool  __gt__(QDeadlineTimer* theWrappedObject, const QDeadlineTimer&  rhs);
   bool  __ge__(QDeadlineTimer* theWrappedObject, const QDeadlineTimer&  rhs);
...
void delete_QDir(QDir* obj) { delete obj; }
   ...
   qsizetype  count(QDir* theWrappedObject, Qt::Disambiguated_t  arg__1 = Qt::Disambiguated) const;
   ...
   bool  __ne__(QDir* theWrappedObject, const QDir&  rhs);
   bool  __eq__(QDir* theWrappedObject, const QDir&  rhs);
...
{ public:
inline QDynamicPropertyChangeEvent&  promoted_operator_assign(const QDynamicPropertyChangeEvent&  other) { return this->QDynamicPropertyChangeEvent::operator=(other); }
...
void delete_QEasingCurve(QEasingCurve* obj) { delete obj; }
   ...
   bool  __ne__(QEasingCurve* theWrappedObject, const QEasingCurve&  rhs);
   ...
   bool  __eq__(QEasingCurve* theWrappedObject, const QEasingCurve&  rhs);
...
void delete_QElapsedTimer(QElapsedTimer* obj) { delete obj; }
   ...
   bool  __lt__(QElapsedTimer* theWrappedObject, const QElapsedTimer&  rhs);
   bool  __le__(QElapsedTimer* theWrappedObject, const QElapsedTimer&  rhs);
   bool  __eq__(QElapsedTimer* theWrappedObject, const QElapsedTimer&  rhs);
   bool  __gt__(QElapsedTimer* theWrappedObject, const QElapsedTimer&  rhs);
   bool  __ge__(QElapsedTimer* theWrappedObject, const QElapsedTimer&  rhs);
...
{ public:
inline QEvent&  promoted_operator_assign(const QEvent&  other) { return this->QEvent::operator=(other); }
...
void delete_QEventLoop(QEventLoop* obj) { delete obj; }
   ...
   void processEvents(QEventLoop* theWrappedObject, QEventLoop::ProcessEventsFlags  flags, QDeadlineTimer  deadline);
...
void delete_QFile(QFile* obj) { delete obj; }
   ...
   bool  static_QFile_supportsMoveToTrash();
...
void delete_QFileInfo(QFileInfo* obj) { delete obj; }
   ...
   QDateTime  birthTime(QFileInfo* theWrappedObject, const QTimeZone&  tz) const;
   ...
   bool  isOther(QFileInfo* theWrappedObject) const;
   ...
   QDateTime  lastModified(QFileInfo* theWrappedObject, const QTimeZone&  tz) const;
   QDateTime  lastRead(QFileInfo* theWrappedObject) const;
   QDateTime  lastRead(QFileInfo* theWrappedObject, const QTimeZone&  tz) const;
   bool  makeAbsolute(QFileInfo* theWrappedObject);
   QDateTime  metadataChangeTime(QFileInfo* theWrappedObject) const;
   QDateTime  metadataChangeTime(QFileInfo* theWrappedObject, const QTimeZone&  tz) const;
   bool  __ne__(QFileInfo* theWrappedObject, const QFileInfo&  rhs);
   bool  __eq__(QFileInfo* theWrappedObject, const QFileInfo&  rhs);
   ...
   QString  readSymLink(QFileInfo* theWrappedObject) const;
...
class PythonQtWrapper_QHashSeed : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QHashSeed* new_QHashSeed(size_t  d = 0);
void delete_QHashSeed(QHashSeed* obj) { delete obj; }
   QHashSeed  static_QHashSeed_globalSeed();
   void static_QHashSeed_resetRandomGlobalSeed();
   void static_QHashSeed_setDeterministicGlobalSeed();
};
...
inline void promoted_setOpenMode(QIODeviceBase::OpenMode  openMode) { this->setOpenMode(openMode); }
...
inline bool  py_q_open(QIODeviceBase::OpenMode  mode) { return QIODevice::open(mode); }
...
inline qint64  py_q_skipData(qint64  maxSize) { return QIODevice::skipData(maxSize); }
...
void delete_QIODevice(QIODevice* obj) { delete obj; }
   ...
   bool  open(QIODevice* theWrappedObject, QIODeviceBase::OpenMode  mode);
   bool  py_q_open(QIODevice* theWrappedObject, QIODeviceBase::OpenMode  mode){  return (((PythonQtPublicPromoter_QIODevice*)theWrappedObject)->py_q_open(mode));}
   QIODeviceBase::OpenMode  openMode(QIODevice* theWrappedObject) const;
   ...
   bool  readLineInto(QIODevice* theWrappedObject, QByteArray*  result, qint64  maxlen = 0);
   ...
   void setOpenMode(QIODevice* theWrappedObject, QIODeviceBase::OpenMode  openMode);
   ...
   qint64  skipData(QIODevice* theWrappedObject, qint64  maxSize);
   qint64  py_q_skipData(QIODevice* theWrappedObject, qint64  maxSize){  return (((PythonQtPublicPromoter_QIODevice*)theWrappedObject)->py_q_skipData(maxSize));}
...
class PythonQtShell_QIODeviceBase : public QIODeviceBase
{
public:
    PythonQtShell_QIODeviceBase():QIODeviceBase(),_wrapper(nullptr) {};

   ~PythonQtShell_QIODeviceBase();


  PythonQtInstanceWrapper* _wrapper;
};

class PythonQtWrapper_QIODeviceBase : public QObject
{ Q_OBJECT
public:
Q_ENUMS(OpenModeFlag )
Q_FLAGS(OpenMode )
enum OpenModeFlag{
  NotOpen = QIODeviceBase::NotOpen,   ReadOnly = QIODeviceBase::ReadOnly,   WriteOnly = QIODeviceBase::WriteOnly,   ReadWrite = QIODeviceBase::ReadWrite,   Append = QIODeviceBase::Append,   Truncate = QIODeviceBase::Truncate,   Text = QIODeviceBase::Text,   Unbuffered = QIODeviceBase::Unbuffered,   NewOnly = QIODeviceBase::NewOnly,   ExistingOnly = QIODeviceBase::ExistingOnly};
Q_DECLARE_FLAGS(OpenMode, OpenModeFlag)
public Q_SLOTS:
QIODeviceBase* new_QIODeviceBase();
};
...
{ public:
inline void promoted_setHandleSourceDataChanges(bool  arg__1) { this->setHandleSourceDataChanges(arg__1); }
inline void promoted_setHandleSourceLayoutChanges(bool  arg__1) { this->setHandleSourceLayoutChanges(arg__1); }
...
void delete_QIdentityProxyModel(QIdentityProxyModel* obj) { delete obj; }
   ...
   bool  handleSourceDataChanges(QIdentityProxyModel* theWrappedObject) const;
   bool  handleSourceLayoutChanges(QIdentityProxyModel* theWrappedObject) const;
   ...
   void setHandleSourceDataChanges(QIdentityProxyModel* theWrappedObject, bool  arg__1);
   void setHandleSourceLayoutChanges(QIdentityProxyModel* theWrappedObject, bool  arg__1);
...
void delete_QJsonArray(QJsonArray* obj) { delete obj; }
   ...
   QJsonValue  at(QJsonArray* theWrappedObject, qsizetype  i) const;
   bool  contains(QJsonArray* theWrappedObject, const QJsonValue&  element) const;
   qsizetype  count(QJsonArray* theWrappedObject) const;
   ...
   bool  __ne__(QJsonArray* theWrappedObject, const QJsonArray&  rhs);
   bool  __ne__(QJsonArray* theWrappedObject, const QJsonValue&  rhs);
   ...
   bool  __eq__(QJsonArray* theWrappedObject, const QJsonArray&  rhs);
   bool  __eq__(QJsonArray* theWrappedObject, const QJsonValue&  rhs);
   void readFrom(QJsonArray* theWrappedObject, QDataStream&  arg__1);
   QJsonValue  operator_subscript(QJsonArray* theWrappedObject, qsizetype  i) const;
   ...
   void removeAt(QJsonArray* theWrappedObject, qsizetype  i);
   void removeFirst(QJsonArray* theWrappedObject);
   void removeLast(QJsonArray* theWrappedObject);
   void replace(QJsonArray* theWrappedObject, qsizetype  i, const QJsonValue&  value);
   qsizetype  size(QJsonArray* theWrappedObject) const;
   void swap(QJsonArray* theWrappedObject, QJsonArray&  other);
   QJsonValue  takeAt(QJsonArray* theWrappedObject, qsizetype  i);
...
void delete_QJsonDocument(QJsonDocument* obj) { delete obj; }
   ...
   bool  __ne__(QJsonDocument* theWrappedObject, const QJsonDocument&  rhs);
   ...
   bool  __eq__(QJsonDocument* theWrappedObject, const QJsonDocument&  rhs);
   ...
   const QJsonValue  operator_subscript(QJsonDocument* theWrappedObject, qsizetype  i) const;
   ...
   QByteArray  toJson(QJsonDocument* theWrappedObject, QJsonDocument::JsonFormat  format = QJsonDocument::JsonFormat::Indented) const;
...
void delete_QJsonObject(QJsonObject* obj) { delete obj; }
   ...
   qsizetype  count(QJsonObject* theWrappedObject) const;
   ...
   qsizetype  length(QJsonObject* theWrappedObject) const;
   bool  __ne__(QJsonObject* theWrappedObject, const QJsonObject&  rhs);
   bool  __ne__(QJsonObject* theWrappedObject, const QJsonValue&  rhs);
   ...
   bool  __eq__(QJsonObject* theWrappedObject, const QJsonObject&  rhs);
   bool  __eq__(QJsonObject* theWrappedObject, const QJsonValue&  rhs);
   ...
   qsizetype  size(QJsonObject* theWrappedObject) const;
...
void delete_QJsonValue(QJsonValue* obj) { delete obj; }
   QJsonValue  static_QJsonValue_fromJson(QByteArrayView  json, QJsonParseError*  error = nullptr);
   ...
   bool  __ne__(QJsonValue* theWrappedObject, const QJsonArray&  rhs);
   bool  __ne__(QJsonValue* theWrappedObject, const QJsonObject&  rhs);
   bool  __ne__(QJsonValue* theWrappedObject, const QJsonValue&  rhs);
   ...
   bool  __eq__(QJsonValue* theWrappedObject, const QJsonArray&  rhs);
   bool  __eq__(QJsonValue* theWrappedObject, const QJsonObject&  rhs);
   bool  __eq__(QJsonValue* theWrappedObject, const QJsonValue&  rhs);
   ...
   const QJsonValue  operator_subscript(QJsonValue* theWrappedObject, qsizetype  i) const;
   ...
   qint64  toInteger(QJsonValue* theWrappedObject, qint64  defaultValue = 0) const;
   QByteArray  toJson(QJsonValue* theWrappedObject, QJsonDocument::JsonFormat  format = JsonFormat::Indented) const;
   ...
   QAnyStringView  toStringView(QJsonValue* theWrappedObject, QAnyStringView  defaultValue = {}) const;
...
void delete_QLibraryInfo(QLibraryInfo* obj) { delete obj; }
   ...
   bool  static_QLibraryInfo_isSharedBuild();
   QString  static_QLibraryInfo_location(QLibraryInfo::LibraryPath  location);
   QString  static_QLibraryInfo_path(QLibraryInfo::LibraryPath  p);
   QStringList  static_QLibraryInfo_paths(QLibraryInfo::LibraryPath  p);
...
void delete_QLockFile(QLockFile* obj) { delete obj; }
   ...
   QString  fileName(QLockFile* theWrappedObject) const;
   ...
   bool  tryLock(QLockFile* theWrappedObject, int  timeout);
...
void delete_QMarginsF(QMarginsF* obj) { delete obj; }
   ...
   bool  __ne__(QMarginsF* theWrappedObject, const QMargins&  rhs);
   ...
   bool  __eq__(QMarginsF* theWrappedObject, const QMargins&  rhs);
   bool  __eq__(QMarginsF* theWrappedObject, const QMarginsF&  rhs);
   void readFrom(QMarginsF* theWrappedObject, QDataStream&  arg__1);
   QMarginsF  __or__(QMarginsF* theWrappedObject, const QMarginsF&  m2);
   qreal  right(QMarginsF* theWrappedObject) const;
   void setBottom(QMarginsF* theWrappedObject, qreal  abottom);
   void setLeft(QMarginsF* theWrappedObject, qreal  aleft);
   void setRight(QMarginsF* theWrappedObject, qreal  aright);
   void setTop(QMarginsF* theWrappedObject, qreal  atop);
...
public:
public Q_SLOTS:
QMessageAuthenticationCode* new_QMessageAuthenticationCode(QCryptographicHash::Algorithm  method, QByteArrayView  key = {});
void delete_QMessageAuthenticationCode(QMessageAuthenticationCode* obj) { delete obj; }
   void addData(QMessageAuthenticationCode* theWrappedObject, QByteArrayView  data);
   bool  addData(QMessageAuthenticationCode* theWrappedObject, QIODevice*  device);
   QByteArray  static_QMessageAuthenticationCode_hash(QByteArrayView  message, QByteArrayView  key, QCryptographicHash::Algorithm  method);
   ...
   QByteArrayView  resultView(QMessageAuthenticationCode* theWrappedObject) const;
   void setKey(QMessageAuthenticationCode* theWrappedObject, QByteArrayView  key);
   void swap(QMessageAuthenticationCode* theWrappedObject, QMessageAuthenticationCode&  other);
};
