...
class PythonQtShell_QAbstractEventDispatcher : public QAbstractEventDispatcher
{
public:
    PythonQtShell_QAbstractEventDispatcher(QObject*  parent = nullptr):QAbstractEventDispatcher(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QAbstractEventDispatcher() override;
...
class PythonQtPublicPromoter_QAbstractEventDispatcher : public QAbstractEventDispatcher
{ public:
inline void py_q_closingDown() { QAbstractEventDispatcher::closingDown(); }
inline void py_q_interrupt() { this->interrupt(); }
inline bool  py_q_processEvents(QEventLoop::ProcessEventsFlags  flags) { return this->processEvents(flags); }
inline void py_q_registerSocketNotifier(QSocketNotifier*  notifier) { this->registerSocketNotifier(notifier); }
inline void py_q_registerTimer(int  timerId, qint64  interval, Qt::TimerType  timerType, QObject*  object) { this->registerTimer(timerId, interval, timerType, object); }
inline QList<QAbstractEventDispatcher::TimerInfo >  py_q_registeredTimers(QObject*  object) const { return this->registeredTimers(object); }
inline int  py_q_remainingTime(int  timerId) { return this->remainingTime(timerId); }
inline void py_q_startingUp() { QAbstractEventDispatcher::startingUp(); }
inline void py_q_unregisterSocketNotifier(QSocketNotifier*  notifier) { this->unregisterSocketNotifier(notifier); }
inline bool  py_q_unregisterTimer(int  timerId) { return this->unregisterTimer(timerId); }
inline bool  py_q_unregisterTimers(QObject*  object) { return this->unregisterTimers(object); }
inline void py_q_wakeUp() { this->wakeUp(); }
};
...
public:
public Q_SLOTS:
QAbstractEventDispatcher* new_QAbstractEventDispatcher(QObject*  parent = nullptr);
void delete_QAbstractEventDispatcher(QAbstractEventDispatcher* obj) { delete obj; }
   ...
   void py_q_closingDown(QAbstractEventDispatcher* theWrappedObject){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_closingDown());}
   bool  filterNativeEvent(QAbstractEventDispatcher* theWrappedObject, const QByteArray&  eventType, void*  message, qintptr*  result);
   ...
   void py_q_interrupt(QAbstractEventDispatcher* theWrappedObject){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_interrupt());}
   bool  processEvents(QAbstractEventDispatcher* theWrappedObject, QEventLoop::ProcessEventsFlags  flags);
   bool  py_q_processEvents(QAbstractEventDispatcher* theWrappedObject, QEventLoop::ProcessEventsFlags  flags){  return (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_processEvents(flags));}
   void registerSocketNotifier(QAbstractEventDispatcher* theWrappedObject, QSocketNotifier*  notifier);
   void py_q_registerSocketNotifier(QAbstractEventDispatcher* theWrappedObject, QSocketNotifier*  notifier){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_registerSocketNotifier(notifier));}
   void registerTimer(QAbstractEventDispatcher* theWrappedObject, int  timerId, qint64  interval, Qt::TimerType  timerType, QObject*  object);
   void py_q_registerTimer(QAbstractEventDispatcher* theWrappedObject, int  timerId, qint64  interval, Qt::TimerType  timerType, QObject*  object){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_registerTimer(timerId, interval, timerType, object));}
   int  registerTimer(QAbstractEventDispatcher* theWrappedObject, qint64  interval, Qt::TimerType  timerType, QObject*  object);
   QList<QAbstractEventDispatcher::TimerInfo >  registeredTimers(QAbstractEventDispatcher* theWrappedObject, QObject*  object) const;
   QList<QAbstractEventDispatcher::TimerInfo >  py_q_registeredTimers(QAbstractEventDispatcher* theWrappedObject, QObject*  object) const{  return (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_registeredTimers(object));}
   int  remainingTime(QAbstractEventDispatcher* theWrappedObject, int  timerId);
   int  py_q_remainingTime(QAbstractEventDispatcher* theWrappedObject, int  timerId){  return (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_remainingTime(timerId));}
   void startingUp(QAbstractEventDispatcher* theWrappedObject);
   void py_q_startingUp(QAbstractEventDispatcher* theWrappedObject){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_startingUp());}
   void unregisterSocketNotifier(QAbstractEventDispatcher* theWrappedObject, QSocketNotifier*  notifier);
   void py_q_unregisterSocketNotifier(QAbstractEventDispatcher* theWrappedObject, QSocketNotifier*  notifier){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_unregisterSocketNotifier(notifier));}
   bool  unregisterTimer(QAbstractEventDispatcher* theWrappedObject, Qt::TimerId  timerId);
   bool  unregisterTimer(QAbstractEventDispatcher* theWrappedObject, int  timerId);
   bool  py_q_unregisterTimer(QAbstractEventDispatcher* theWrappedObject, int  timerId){  return (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_unregisterTimer(timerId));}
   bool  unregisterTimers(QAbstractEventDispatcher* theWrappedObject, QObject*  object);
   bool  py_q_unregisterTimers(QAbstractEventDispatcher* theWrappedObject, QObject*  object){  return (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_unregisterTimers(object));}
   void wakeUp(QAbstractEventDispatcher* theWrappedObject);
   void py_q_wakeUp(QAbstractEventDispatcher* theWrappedObject){  (((PythonQtPublicPromoter_QAbstractEventDispatcher*)theWrappedObject)->py_q_wakeUp());}
};
...
{
public:
    PythonQtShell_QAbstractEventDispatcher__TimerInfo():QAbstractEventDispatcher::TimerInfo(),_wrapper(nullptr) {};
...
public:
public Q_SLOTS:
QAbstractEventDispatcher::TimerInfo* new_QAbstractEventDispatcher__TimerInfo();
...
inline void py_q_multiData(const QModelIndex&  index, QModelRoleDataSpan  roleDataSpan) const { QAbstractItemModel::multiData(index, roleDataSpan); }
...
void delete_QAbstractItemModel(QAbstractItemModel* obj) { delete obj; }
   ...
   void multiData(QAbstractItemModel* theWrappedObject, const QModelIndex&  index, QModelRoleDataSpan  roleDataSpan) const;
   void py_q_multiData(QAbstractItemModel* theWrappedObject, const QModelIndex&  index, QModelRoleDataSpan  roleDataSpan) const{  (((PythonQtPublicPromoter_QAbstractItemModel*)theWrappedObject)->py_q_multiData(index, roleDataSpan));}
...
{ public:
inline QApplicationStateChangeEvent&  promoted_operator_assign(const QApplicationStateChangeEvent&  other) { return this->QApplicationStateChangeEvent::operator=(other); }
...
class PythonQtShell_QBasicReadWriteLock : public QBasicReadWriteLock
{
public:
    PythonQtShell_QBasicReadWriteLock():QBasicReadWriteLock(),_wrapper(nullptr) {};

   ~PythonQtShell_QBasicReadWriteLock();


  PythonQtInstanceWrapper* _wrapper;
};

class PythonQtPublicPromoter_QBasicReadWriteLock : public QBasicReadWriteLock
{ public:
inline bool  promoted_contendedTryLockForRead(QDeadlineTimer  timeout, void*  dd) { return this->contendedTryLockForRead(timeout, dd); }
inline bool  promoted_contendedTryLockForWrite(QDeadlineTimer  timeout, void*  dd) { return this->contendedTryLockForWrite(timeout, dd); }
inline void promoted_contendedUnlock(void*  dd) { this->contendedUnlock(dd); }
inline bool  promoted_isContendedLockForRead(const void*  dd) { return this->isContendedLockForRead(dd); }
};

class PythonQtWrapper_QBasicReadWriteLock : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QBasicReadWriteLock* new_QBasicReadWriteLock();
void delete_QBasicReadWriteLock(QBasicReadWriteLock* obj) { delete obj; }
   bool  contendedTryLockForRead(QBasicReadWriteLock* theWrappedObject, QDeadlineTimer  timeout, void*  dd);
   bool  contendedTryLockForWrite(QBasicReadWriteLock* theWrappedObject, QDeadlineTimer  timeout, void*  dd);
   void contendedUnlock(QBasicReadWriteLock* theWrappedObject, void*  dd);
   bool  isContendedLockForRead(QBasicReadWriteLock* theWrappedObject, const void*  dd);
   void lock(QBasicReadWriteLock* theWrappedObject);
   void lockForRead(QBasicReadWriteLock* theWrappedObject);
   void lockForWrite(QBasicReadWriteLock* theWrappedObject);
   void lock_shared(QBasicReadWriteLock* theWrappedObject);
   bool  tryLockForRead(QBasicReadWriteLock* theWrappedObject);
   bool  tryLockForRead(QBasicReadWriteLock* theWrappedObject, QDeadlineTimer  timeout);
   bool  tryLockForWrite(QBasicReadWriteLock* theWrappedObject);
   bool  tryLockForWrite(QBasicReadWriteLock* theWrappedObject, QDeadlineTimer  timeout);
   bool  try_lock(QBasicReadWriteLock* theWrappedObject);
   bool  try_lock_shared(QBasicReadWriteLock* theWrappedObject);
   void unlock(QBasicReadWriteLock* theWrappedObject);
   void unlock_shared(QBasicReadWriteLock* theWrappedObject);
};
...
void delete_QBasicTimer(QBasicTimer* obj) { delete obj; }
   Qt::TimerId  id(QBasicTimer* theWrappedObject) const;
...
void delete_QByteArrayMatcher(QByteArrayMatcher* obj) { delete obj; }
   qsizetype  indexIn(QByteArrayMatcher* theWrappedObject, QByteArrayView  data, qsizetype  from = 0) const;
...
QCalendar* new_QCalendar(QAnyStringView  name);
...
void delete_QCalendar(QCalendar* obj) { delete obj; }
   ...
   QString  dateTimeToString(QCalendar* theWrappedObject, QStringView  format, const QDateTime&  datetime, QDate  dateOnly, QTime  timeOnly, const QLocale&  locale) const;
   ...
   QDate  matchCenturyToWeekday(QCalendar* theWrappedObject, const QCalendar::YearMonthDay&  parts, int  dow) const;
...
void delete_QCborArray(QCborArray* obj) { delete obj; }
   ...
   bool  __ne__(QCborArray* theWrappedObject, const QCborArray&  rhs);
   bool  __ne__(QCborArray* theWrappedObject, const QCborValue&  rhs);
   ...
   bool  __lt__(QCborArray* theWrappedObject, const QCborArray&  rhs);
   bool  __lt__(QCborArray* theWrappedObject, const QCborValue&  rhs);
   ...
   bool  __le__(QCborArray* theWrappedObject, const QCborArray&  rhs);
   bool  __le__(QCborArray* theWrappedObject, const QCborValue&  rhs);
   QCborArray*  operator_assign(QCborArray* theWrappedObject, const QCborArray&  other);
   bool  __eq__(QCborArray* theWrappedObject, const QCborArray&  rhs);
   bool  __eq__(QCborArray* theWrappedObject, const QCborValue&  rhs);
   bool  __gt__(QCborArray* theWrappedObject, const QCborArray&  rhs);
   bool  __gt__(QCborArray* theWrappedObject, const QCborValue&  rhs);
   bool  __ge__(QCborArray* theWrappedObject, const QCborArray&  rhs);
   bool  __ge__(QCborArray* theWrappedObject, const QCborValue&  rhs);
...
void delete_QCborMap(QCborMap* obj) { delete obj; }
   ...
   QList<QCborValue >  keys(QCborMap* theWrappedObject) const;
   bool  __ne__(QCborMap* theWrappedObject, const QCborMap&  rhs);
   bool  __ne__(QCborMap* theWrappedObject, const QCborValue&  rhs);
   bool  __lt__(QCborMap* theWrappedObject, const QCborMap&  rhs);
   bool  __lt__(QCborMap* theWrappedObject, const QCborValue&  rhs);
   void writeTo(QCborMap* theWrappedObject, QDataStream&  arg__1);
   bool  __le__(QCborMap* theWrappedObject, const QCborMap&  rhs);
   bool  __le__(QCborMap* theWrappedObject, const QCborValue&  rhs);
   QCborMap*  operator_assign(QCborMap* theWrappedObject, const QCborMap&  other);
   bool  __eq__(QCborMap* theWrappedObject, const QCborMap&  rhs);
   bool  __eq__(QCborMap* theWrappedObject, const QCborValue&  rhs);
   bool  __gt__(QCborMap* theWrappedObject, const QCborMap&  rhs);
   bool  __gt__(QCborMap* theWrappedObject, const QCborValue&  rhs);
   bool  __ge__(QCborMap* theWrappedObject, const QCborMap&  rhs);
   bool  __ge__(QCborMap* theWrappedObject, const QCborValue&  rhs);
...
void delete_QCborStreamReader(QCborStreamReader* obj) { delete obj; }
   ...
   QCborError  lastError(QCborStreamReader* theWrappedObject) const;
   ...
   QByteArray  readAllByteArray(QCborStreamReader* theWrappedObject);
   QString  readAllString(QCborStreamReader* theWrappedObject);
   QByteArray  readAllUtf8String(QCborStreamReader* theWrappedObject);
   bool  readAndAppendToByteArray(QCborStreamReader* theWrappedObject, QByteArray&  dst);
   bool  readAndAppendToString(QCborStreamReader* theWrappedObject, QString&  dst);
   bool  readAndAppendToUtf8String(QCborStreamReader* theWrappedObject, QByteArray&  dst);
...
void delete_QCborStreamWriter(QCborStreamWriter* obj) { delete obj; }
   void append(QCborStreamWriter* theWrappedObject, QByteArrayView  ba);
...
void delete_QCborValue(QCborValue* obj) { delete obj; }
   ...
   bool  __ne__(QCborValue* theWrappedObject, const QCborArray&  rhs);
   bool  __ne__(QCborValue* theWrappedObject, const QCborMap&  rhs);
   bool  __ne__(QCborValue* theWrappedObject, const QCborValue&  rhs);
   bool  __lt__(QCborValue* theWrappedObject, const QCborArray&  rhs);
   bool  __lt__(QCborValue* theWrappedObject, const QCborMap&  rhs);
   bool  __lt__(QCborValue* theWrappedObject, const QCborValue&  rhs);
   void writeTo(QCborValue* theWrappedObject, QDataStream&  arg__1);
   bool  __le__(QCborValue* theWrappedObject, const QCborArray&  rhs);
   bool  __le__(QCborValue* theWrappedObject, const QCborMap&  rhs);
   bool  __le__(QCborValue* theWrappedObject, const QCborValue&  rhs);
   QCborValue*  operator_assign(QCborValue* theWrappedObject, const QCborValue&  other);
   bool  __eq__(QCborValue* theWrappedObject, const QCborArray&  rhs);
   bool  __eq__(QCborValue* theWrappedObject, const QCborMap&  rhs);
   bool  __eq__(QCborValue* theWrappedObject, const QCborValue&  rhs);
   bool  __gt__(QCborValue* theWrappedObject, const QCborArray&  rhs);
   bool  __gt__(QCborValue* theWrappedObject, const QCborMap&  rhs);
   bool  __gt__(QCborValue* theWrappedObject, const QCborValue&  rhs);
   bool  __ge__(QCborValue* theWrappedObject, const QCborArray&  rhs);
   bool  __ge__(QCborValue* theWrappedObject, const QCborMap&  rhs);
   bool  __ge__(QCborValue* theWrappedObject, const QCborValue&  rhs);
   ...
   void toCbor(QCborValue* theWrappedObject, QCborStreamWriter&  writer, QCborValue::EncodingOptions  opt = QCborValue::NoTransformation) const;
   QByteArray  toCbor(QCborValue* theWrappedObject, QCborValue::EncodingOptions  opt = QCborValue::NoTransformation) const;
   ...
   QAnyStringView  toStringView(QCborValue* theWrappedObject, QAnyStringView  defaultValue = {}) const;
...
{ public:
inline QChildEvent&  promoted_operator_assign(const QChildEvent&  other) { return this->QChildEvent::operator=(other); }
...
void delete_QCollator(QCollator* obj) { delete obj; }
   ...
   int  static_QCollator_defaultCompare(QStringView  s1, QStringView  s2);
   QCollatorSortKey  static_QCollator_defaultSortKey(QStringView  key);
...
Q_ENUMS(Flag )
enum Flag{
  HiddenFromHelp = QCommandLineOption::HiddenFromHelp,   ShortOptionStyle = QCommandLineOption::ShortOptionStyle,   IgnoreOptionsAfter = QCommandLineOption::IgnoreOptionsAfter};
public Q_SLOTS:
...
{ Q_OBJECT
public:
Q_ENUMS(MessageType OptionsAfterPositionalArgumentsMode SingleDashWordOptionMode )
enum class MessageType{
  Information = static_cast<int>(QCommandLineParser::MessageType::Information),   Error = static_cast<int>(QCommandLineParser::MessageType::Error)};
...
void delete_QCommandLineParser(QCommandLineParser* obj) { delete obj; }
   ...
   void static_QCommandLineParser_showMessageAndExit(QCommandLineParser::MessageType  type, const QString&  message, int  exitCode = 0);
...
void delete_QCoreApplication(QCoreApplication* obj) { delete obj; }
   ...
   bool  static_QCoreApplication_instanceExists();
   ...
   void static_QCoreApplication_processEvents(QEventLoop::ProcessEventsFlags  flags, QDeadlineTimer  deadline);
...
void delete_QCryptographicHash(QCryptographicHash* obj) { delete obj; }
   void addData(QCryptographicHash* theWrappedObject, QByteArrayView  data);
   ...
   QByteArray  static_QCryptographicHash_hash(QByteArrayView  data, QCryptographicHash::Algorithm  method);
   ...
   QByteArrayView  resultView(QCryptographicHash* theWrappedObject) const;
...
void delete_QDataStream(QDataStream* obj) { delete obj; }
   ...
   bool  operator_cast_bool(QDataStream* theWrappedObject) const;
   QDataStream*  __lshift__(QDataStream* theWrappedObject, char  i);
   QDataStream*  __rshift__(QDataStream* theWrappedObject, char&  i);
   QDataStream*  readBytes(QDataStream* theWrappedObject, char*&  arg__1, qint64&  len);
   qint64  readRawData(QDataStream* theWrappedObject, char*  arg__1, qint64  len);
   ...
   qint64  skipRawData(QDataStream* theWrappedObject, qint64  len);
   ...
   QDataStream*  writeBytes(QDataStream* theWrappedObject, const char*  arg__1, qint64  len);
   qint64  writeRawData(QDataStream* theWrappedObject, const char*  arg__1, qint64  len);
