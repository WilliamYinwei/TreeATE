...
{
public:
    PythonQtShell_QSqlDatabase():QSqlDatabase(),_wrapper(nullptr) {};
    PythonQtShell_QSqlDatabase(QSqlDriver*  driver):QSqlDatabase(driver),_wrapper(nullptr) {};
    PythonQtShell_QSqlDatabase(const QSqlDatabase&  other):QSqlDatabase(other),_wrapper(nullptr) {};
    PythonQtShell_QSqlDatabase(const QString&  type):QSqlDatabase(type),_wrapper(nullptr) {};
...
void delete_QSqlDatabase(QSqlDatabase* obj) { delete obj; }
   ...
   bool  moveToThread(QSqlDatabase* theWrappedObject, QThread*  targetThread);
   ...
   QThread*  thread(QSqlDatabase* theWrappedObject) const;
...
class PythonQtShell_QSqlDatabaseDefaultConnectionName : public QSqlDatabaseDefaultConnectionName
{
public:
    PythonQtShell_QSqlDatabaseDefaultConnectionName():QSqlDatabaseDefaultConnectionName(),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlDatabaseDefaultConnectionName();


  PythonQtInstanceWrapper* _wrapper;
};

class PythonQtWrapper_QSqlDatabaseDefaultConnectionName : public QObject
{ Q_OBJECT
public:
public Q_SLOTS:
QSqlDatabaseDefaultConnectionName* new_QSqlDatabaseDefaultConnectionName();
QSqlDatabaseDefaultConnectionName* new_QSqlDatabaseDefaultConnectionName(const QSqlDatabaseDefaultConnectionName& other) {
PythonQtShell_QSqlDatabaseDefaultConnectionName* a = new PythonQtShell_QSqlDatabaseDefaultConnectionName();
*((QSqlDatabaseDefaultConnectionName*)a) = other;
return a; }
void delete_QSqlDatabaseDefaultConnectionName(QSqlDatabaseDefaultConnectionName* obj) { delete obj; }
   QString  static_QSqlDatabaseDefaultConnectionName_defaultConnectionName();
};
...
{
public:
    PythonQtShell_QSqlDriver(QObject*  parent = nullptr):QSqlDriver(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlDriver() override;
...
int  maximumIdentifierLength(QSqlDriver::IdentifierType  type) const override;
...
inline int  py_q_maximumIdentifierLength(QSqlDriver::IdentifierType  type) const { return QSqlDriver::maximumIdentifierLength(type); }
...
enum DbmsType{
  UnknownDbms = QSqlDriver::UnknownDbms,   MSSqlServer = QSqlDriver::MSSqlServer,   MySqlServer = QSqlDriver::MySqlServer,   PostgreSQL = QSqlDriver::PostgreSQL,   Oracle = QSqlDriver::Oracle,   Sybase = QSqlDriver::Sybase,   SQLite = QSqlDriver::SQLite,   Interbase = QSqlDriver::Interbase,   DB2 = QSqlDriver::DB2,   MimerSQL = QSqlDriver::MimerSQL};
enum DriverFeature{
...
void delete_QSqlDriver(QSqlDriver* obj) { delete obj; }
   ...
   QString  connectionName(QSqlDriver* theWrappedObject) const;
   ...
   int  maximumIdentifierLength(QSqlDriver* theWrappedObject, QSqlDriver::IdentifierType  type) const;
   int  py_q_maximumIdentifierLength(QSqlDriver* theWrappedObject, QSqlDriver::IdentifierType  type) const{  return (((PythonQtPublicPromoter_QSqlDriver*)theWrappedObject)->py_q_maximumIdentifierLength(type));}
...
{
public:
    PythonQtShell_QSqlDriverCreatorBase():QSqlDriverCreatorBase(),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlDriverCreatorBase() override;
...
QSqlError* new_QSqlError(const QString&  driverText = QString(), const QString&  databaseText = QString(), QSqlError::ErrorType  type = QSqlError::NoError, const QString&  nativeErrorCode = QString());
void delete_QSqlError(QSqlError* obj) { delete obj; }
   ...
   void swap(QSqlError* theWrappedObject, QSqlError&  other);
...
void delete_QSqlField(QSqlField* obj) { delete obj; }
   ...
   void swap(QSqlField* theWrappedObject, QSqlField&  other);
...
void delete_QSqlIndex(QSqlIndex* obj) { delete obj; }
   ...
   void swap(QSqlIndex* theWrappedObject, QSqlIndex&  other);
...
void delete_QSqlQuery(QSqlQuery* obj) { delete obj; }
   ...
   QString  boundValueName(QSqlQuery* theWrappedObject, int  pos) const;
   QStringList  boundValueNames(QSqlQuery* theWrappedObject) const;
   ...
   bool  isNull(QSqlQuery* theWrappedObject, QAnyStringView  name) const;
   bool  isNull(QSqlQuery* theWrappedObject, int  field) const;
   bool  isPositionalBindingEnabled(QSqlQuery* theWrappedObject) const;
   ...
   void setPositionalBindingEnabled(QSqlQuery* theWrappedObject, bool  enable);
   int  size(QSqlQuery* theWrappedObject) const;
   void swap(QSqlQuery* theWrappedObject, QSqlQuery&  other);
   QVariant  value(QSqlQuery* theWrappedObject, QAnyStringView  name) const;
...
{
public:
    PythonQtShell_QSqlQueryModel(QObject*  parent = nullptr):QSqlQueryModel(parent),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlQueryModel() override;
...
inline QHash<int , QByteArray >  py_q_roleNames() const { return QSqlQueryModel::roleNames(); }
...
void delete_QSqlQueryModel(QSqlQueryModel* obj) { delete obj; }
   ...
   const QSqlQuery*  query(QSqlQueryModel* theWrappedObject, Qt::Disambiguated_t  arg__1 = Qt::Disambiguated) const;
   ...
   void refresh(QSqlQueryModel* theWrappedObject);
   ...
   QHash<int , QByteArray >  py_q_roleNames(QSqlQueryModel* theWrappedObject) const{  return (((PythonQtPublicPromoter_QSqlQueryModel*)theWrappedObject)->py_q_roleNames());}
...
void delete_QSqlRecord(QSqlRecord* obj) { delete obj; }
   ...
   bool  contains(QSqlRecord* theWrappedObject, QAnyStringView  name) const;
   int  count(QSqlRecord* theWrappedObject) const;
   QSqlField  field(QSqlRecord* theWrappedObject, QAnyStringView  name) const;
   QSqlField  field(QSqlRecord* theWrappedObject, int  i) const;
   QString  fieldName(QSqlRecord* theWrappedObject, int  i) const;
   int  indexOf(QSqlRecord* theWrappedObject, QAnyStringView  name) const;
   void insert(QSqlRecord* theWrappedObject, int  pos, const QSqlField&  field);
   bool  isEmpty(QSqlRecord* theWrappedObject) const;
   bool  isGenerated(QSqlRecord* theWrappedObject, QAnyStringView  name) const;
   bool  isGenerated(QSqlRecord* theWrappedObject, int  i) const;
   bool  isNull(QSqlRecord* theWrappedObject, QAnyStringView  name) const;
   ...
   void setGenerated(QSqlRecord* theWrappedObject, QAnyStringView  name, bool  generated);
   void setGenerated(QSqlRecord* theWrappedObject, int  i, bool  generated);
   void setNull(QSqlRecord* theWrappedObject, QAnyStringView  name);
   void setNull(QSqlRecord* theWrappedObject, int  i);
   void setValue(QSqlRecord* theWrappedObject, QAnyStringView  name, const QVariant&  val);
   void setValue(QSqlRecord* theWrappedObject, int  i, const QVariant&  val);
   void swap(QSqlRecord* theWrappedObject, QSqlRecord&  other);
   QVariant  value(QSqlRecord* theWrappedObject, QAnyStringView  name) const;
...
void delete_QSqlRelation(QSqlRelation* obj) { delete obj; }
   ...
   void swap(QSqlRelation* theWrappedObject, QSqlRelation&  other);
...
{
public:
    PythonQtShell_QSqlRelationalTableModel(QObject*  parent = nullptr, const QSqlDatabase&  db = QSqlDatabase()):QSqlRelationalTableModel(parent, db),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlRelationalTableModel() override;
...
public Q_SLOTS:
QSqlRelationalTableModel* new_QSqlRelationalTableModel(QObject*  parent = nullptr, const QSqlDatabase&  db = QSqlDatabase());
...
{
public:
    PythonQtShell_QSqlResult(const QSqlDriver*  db):QSqlResult(db),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlResult() override;

void bindValue(const QString&  placeholder, const QVariant&  val, QSql::ParamType  type) override;
void bindValue(int  pos, const QVariant&  val, QSql::ParamType  type) override;
...
inline QStringList  promoted_boundValueNames() const { return this->boundValueNames(); }
inline QList<QVariant >  promoted_boundValues(Qt::Disambiguated_t  arg__1 = Qt::Disambiguated) const { return this->boundValues(arg__1); }
...
inline bool  promoted_isPositionalBindingEnabled() const { return this->isPositionalBindingEnabled(); }
...
inline void promoted_setPositionalBindingEnabled(bool  enable) { this->setPositionalBindingEnabled(enable); }
...
void delete_QSqlResult(QSqlResult* obj) { delete obj; }
   ...
   QStringList  boundValueNames(QSqlResult* theWrappedObject) const;
   QList<QVariant >  boundValues(QSqlResult* theWrappedObject, Qt::Disambiguated_t  arg__1 = Qt::Disambiguated) const;
   ...
   bool  isPositionalBindingEnabled(QSqlResult* theWrappedObject) const;
   ...
   void setPositionalBindingEnabled(QSqlResult* theWrappedObject, bool  enable);
...
{
public:
    PythonQtShell_QSqlTableModel(QObject*  parent = nullptr, const QSqlDatabase&  db = QSqlDatabase()):QSqlTableModel(parent, db),_wrapper(nullptr) {};

   ~PythonQtShell_QSqlTableModel() override;
...
inline bool  py_q_clearItemData(const QModelIndex&  index) { return QSqlTableModel::clearItemData(index); }
...
public Q_SLOTS:
QSqlTableModel* new_QSqlTableModel(QObject*  parent = nullptr, const QSqlDatabase&  db = QSqlDatabase());
void delete_QSqlTableModel(QSqlTableModel* obj) { delete obj; }
   ...
   bool  py_q_clearItemData(QSqlTableModel* theWrappedObject, const QModelIndex&  index){  return (((PythonQtPublicPromoter_QSqlTableModel*)theWrappedObject)->py_q_clearItemData(index));}
