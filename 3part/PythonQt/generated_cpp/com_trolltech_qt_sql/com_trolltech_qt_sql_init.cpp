...
PythonQt::priv()->registerCPPClass("QSqlDatabase", "QSqlDatabaseDefaultConnectionName", "QtSql", PythonQtCreateObject<PythonQtWrapper_QSqlDatabase>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QSqlDatabase>, module, PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QSqlDatabaseDefaultConnectionName", "", "QtSql", PythonQtCreateObject<PythonQtWrapper_QSqlDatabaseDefaultConnectionName>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QSqlDatabaseDefaultConnectionName>, module, 0);
